...
* colors			: Css colors
* elements			: Element storage
* variables			: Variable storage
* languageSet		: Language pack
* public events
* public functions
*/
function getVanillanote() {
	/* @preserve */
	function Vanillanote() {
		//cosnt
		this.consts = {
			// Start possible tags
		...
		this.elementEvents = {
			//textarea event
			textarea_onBeforeClick : function(e) {return true;},
			textarea_onAfterClick : function(e) {},
			textarea_onBeforeFocus : function(e) {return true;},
			textarea_onAfterFocus : function(e) {},
			textarea_onBeforeBlur : function(e) {return true;},
			textarea_onAfterBlur : function(e) {},
			
			//paragraphStyleSelect event
			paragraphStyleSelect_onBeforeClick : function(e) {return true;},
			paragraphStyleSelect_onAfterClick : function(e) {},
			
			//==================================================================================
			//toolToggleButton event
			toolToggleButton_onBeforeClick : function(e) {return true;},
			toolToggleButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//styleNomal event
			styleNomal_onBeforeClick : function(e) {return true;},
			styleNomal_onAfterClick : function(e) {},
			
			//==================================================================================
			//styleHeader1 event
			styleHeader1_onBeforeClick : function(e) {return true;},
			styleHeader1_onAfterClick : function(e) {},
			
			//==================================================================================
			//styleHeader2 event
			styleHeader2_onBeforeClick : function(e) {return true;},
			styleHeader2_onAfterClick : function(e) {},
			
			//==================================================================================
			//styleHeader3 event
			styleHeader3_onBeforeClick : function(e) {return true;},
			styleHeader3_onAfterClick : function(e) {},
			
			//==================================================================================
			//styleHeader4 event
			styleHeader4_onBeforeClick : function(e) {return true;},
			styleHeader4_onAfterClick : function(e) {},
			
			//==================================================================================
			//styleHeader5 event
			styleHeader5_onBeforeClick : function(e) {return true;},
			styleHeader5_onAfterClick : function(e) {},
			
			//==================================================================================
			//styleHeader6 event
			styleHeader6_onBeforeClick : function(e) {return true;},
			styleHeader6_onAfterClick : function(e) {},
			
			//==================================================================================
			//boldButton event
			boldButton_onBeforeClick : function(e) {return true;},
			boldButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//underlineButton event
			underlineButton_onBeforeClick : function(e) {return true;},
			underlineButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//italicButton event
			italicButton_onBeforeClick : function(e) {return true;},
			italicButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//ulButton event
			ulButton_onBeforeClick : function(e) {return true;},
			ulButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//olButton event
			olButton_onBeforeClick : function(e) {return true;},
			olButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//textAlignSelect event
			textAlignSelect_onBeforeClick : function(e) {return true;},
			textAlignSelect_onAfterClick : function(e) {},
			
			//==================================================================================
			//textAlignLeft event
			textAlignLeft_onBeforeClick : function(e) {return true;},
			textAlignLeft_onAfterClick : function(e) {},
			
			//==================================================================================
			//textAlignCenter event
			textAlignCenter_onBeforeClick : function(e) {return true;},
			textAlignCenter_onAfterClick : function(e) {},
			
			//==================================================================================
			//textAlignRight event
			textAlignRight_onBeforeClick : function(e) {return true;},
			textAlignRight_onAfterClick : function(e) {},
			
			//==================================================================================
			//attLinkButton event
			attLinkButton_onBeforeClick : function(e) {return true;},
			attLinkButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//attFileButton event
			attFileButton_onBeforeClick : function(e) {return true;},
			attFileButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//attImageButton event
			attImageButton_onBeforeClick : function(e) {return true;},
			attImageButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//attVideoButton event
			attVideoButton_onBeforeClick : function(e) {return true;},
			attVideoButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//fontSizeInputBox event
			fontSizeInputBox_onBeforeClick : function(e) {return true;},
			fontSizeInputBox_onAfterClick : function(e) {},
			
			//==================================================================================
			//fontSizeInput event
			fontSizeInput_onBeforeClick : function(e) {return true;},
			fontSizeInput_onAfterClick : function(e) {},
			fontSizeInput_onBeforeInput : function(e) {return true;},
			fontSizeInput_onAfterInput : function(e) {},
			fontSizeInput_onBeforeBlur : function(e) {return true;},
			fontSizeInput_onAfterBlur : function(e) {},
			
			//==================================================================================
			//letterSpacingInputBox event
			letterSpacingInputBox_onBeforeClick : function(e) {return true;},
			letterSpacingInputBox_onAfterClick : function(e) {},
			
			//==================================================================================
			//letterSpacingInput event
			letterSpacingInput_onBeforeClick : function(e) {return true;},
			letterSpacingInput_onAfterClick : function(e) {},
			letterSpacingInput_onBeforeInput : function(e) {return true;},
			letterSpacingInput_onAfterInput : function(e) {},
			letterSpacingInput_onBeforeBlur : function(e) {return true;},
			letterSpacingInput_onAfterBlur : function(e) {},
			
			//==================================================================================
			//lineHeightInputBox event
			lineHeightInputBox_onBeforeClick : function(e) {return true;},
			lineHeightInputBox_onAfterClick : function(e) {},
			
			//==================================================================================
			//lineHeightInput event
			lineHeightInput_onBeforeClick : function(e) {return true;},
			lineHeightInput_onAfterClick : function(e) {},
			lineHeightInput_onBeforeInput : function(e) {return true;},
			lineHeightInput_onAfterInput : function(e) {},
			lineHeightInput_onBeforeBlur : function(e) {return true;},
			lineHeightInput_onAfterBlur : function(e) {},
			
			//==================================================================================
			//fontFamilySelect event
			fontFamilySelect_onBeforeClick : function(e) {return true;},
			fontFamilySelect_onAfterClick : function(e) {},
			
			//==================================================================================
			//color text select
			colorTextSelect_onBeforeClick : function(e) {return true;},
			colorTextSelect_onAfterClick : function(e) {},
			//color text select box
			colorTextSelectBox_onBeforeClick : function(e) {return true;},
			colorTextSelectBox_onAfterClick : function(e) {},
			//colorText0 button
			colorText0_onBeforeClick : function(e) {return true;},
			colorText0_onAfterClick : function(e) {},
			//colorText1 button
			colorText1_onBeforeClick : function(e) {return true;},
			colorText1_onAfterClick : function(e) {},
			//colorText2 button
			colorText2_onBeforeClick : function(e) {return true;},
			colorText2_onAfterClick : function(e) {},
			//colorText3 button
			colorText3_onBeforeClick : function(e) {return true;},
			colorText3_onAfterClick : function(e) {},
			//colorText4 button
			colorText4_onBeforeClick : function(e) {return true;},
			colorText4_onAfterClick : function(e) {},
			//colorText5 button
			colorText5_onBeforeClick : function(e) {return true;},
			colorText5_onAfterClick : function(e) {},
			//colorText6 button
			colorText6_onBeforeClick : function(e) {return true;},
			colorText6_onAfterClick : function(e) {},
			//colorText7 button
			colorText7_onBeforeClick : function(e) {return true;},
			colorText7_onAfterClick : function(e) {},
			//colorText R Input event
			colorTextRInput_onBeforeClick : function(e) {return true;},
			colorTextRInput_onAfterClick : function(e) {},
			colorTextRInput_onBeforeInput : function(e) {return true;},
			colorTextRInput_onAfterInput : function(e) {},
			colorTextRInput_onBeforeBlur : function(e) {return true;},
			colorTextRInput_onAfterBlur : function(e) {},
			//colorText G Input event
			colorTextGInput_onBeforeClick : function(e) {return true;},
			colorTextGInput_onAfterClick : function(e) {},
			colorTextGInput_onBeforeInput : function(e) {return true;},
			colorTextGInput_onAfterInput : function(e) {},
			colorTextGInput_onBeforeBlur : function(e) {return true;},
			colorTextGInput_onAfterBlur : function(e) {},
			//colorText B Input event
			colorTextBInput_onBeforeClick : function(e) {return true;},
			colorTextBInput_onAfterClick : function(e) {},
			colorTextBInput_onBeforeInput : function(e) {return true;},
			colorTextBInput_onAfterInput : function(e) {},
			colorTextBInput_onBeforeBlur : function(e) {return true;},
			colorTextBInput_onAfterBlur : function(e) {},
			//colorText Opacity Input event
			colorTextOpacityInput_onBeforeClick : function(e) {return true;},
			colorTextOpacityInput_onAfterClick : function(e) {},
			colorTextOpacityInput_onBeforeInput : function(e) {return true;},
			colorTextOpacityInput_onAfterInput : function(e) {},
			colorTextOpacityInput_onBeforeBlur : function(e) {return true;},
			colorTextOpacityInput_onAfterBlur : function(e) {},
			
			//==================================================================================
			//color background select
			colorBackSelect_onBeforeClick : function(e) {return true;},
			colorBackSelect_onAfterClick : function(e) {},
			//color back select box
			colorBackSelectBox_onBeforeClick : function(e) {return true;},
			colorBackSelectBox_onAfterClick : function(e) {},
			//colorBack0 button
			colorBack0_onBeforeClick : function(e) {return true;},
			colorBack0_onAfterClick : function(e) {},
			//colorBack1 button
			colorBack1_onBeforeClick : function(e) {return true;},
			colorBack1_onAfterClick : function(e) {},
			//colorBack2 button
			colorBack2_onBeforeClick : function(e) {return true;},
			colorBack2_onAfterClick : function(e) {},
			//colorBack3 button
			colorBack3_onBeforeClick : function(e) {return true;},
			colorBack3_onAfterClick : function(e) {},
			//colorBack4 button
			colorBack4_onBeforeClick : function(e) {return true;},
			colorBack4_onAfterClick : function(e) {},
			//colorBack5 button
			colorBack5_onBeforeClick : function(e) {return true;},
			colorBack5_onAfterClick : function(e) {},
			//colorBack6 button
			colorBack6_onBeforeClick : function(e) {return true;},
			colorBack6_onAfterClick : function(e) {},
			//colorBack7 button
			colorBack7_onBeforeClick : function(e) {return true;},
			colorBack7_onAfterClick : function(e) {},
			//colorBack R Input event
			colorBackRInput_onBeforeClick : function(e) {return true;},
			colorBackRInput_onAfterClick : function(e) {},
			colorBackRInput_onBeforeInput : function(e) {return true;},
			colorBackRInput_onAfterInput : function(e) {},
			colorBackRInput_onBeforeBlur : function(e) {return true;},
			colorBackRInput_onAfterBlur : function(e) {},
			//colorBack G Input event
			colorBackGInput_onBeforeClick : function(e) {return true;},
			colorBackGInput_onAfterClick : function(e) {},
			colorBackGInput_onBeforeInput : function(e) {return true;},
			colorBackGInput_onAfterInput : function(e) {},
			colorBackGInput_onBeforeBlur : function(e) {return true;},
			colorBackGInput_onAfterBlur : function(e) {},
			//colorBack B Input event
			colorBackBInput_onBeforeClick : function(e) {return true;},
			colorBackBInput_onAfterClick : function(e) {},
			colorBackBInput_onBeforeInput : function(e) {return true;},
			colorBackBInput_onAfterInput : function(e) {},
			colorBackBInput_onBeforeBlur : function(e) {return true;},
			colorBackBInput_onAfterBlur : function(e) {},
			//colorBack Opacity Input event
			colorBackOpacityInput_onBeforeClick : function(e) {return true;},
			colorBackOpacityInput_onAfterClick : function(e) {},
			colorBackOpacityInput_onBeforeInput : function(e) {return true;},
			colorBackOpacityInput_onAfterInput : function(e) {},
			colorBackOpacityInput_onBeforeBlur : function(e) {return true;},
			colorBackOpacityInput_onAfterBlur : function(e) {},
			
			//==================================================================================
			//formatClearButton event
			formatClearButton_onBeforeClick : function(e) {return true;},
			formatClearButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//undo event
			undoButton_onBeforeClick : function(e) {return true;},
			undoButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//redo event
			redoButton_onBeforeClick : function(e) {return true;},
			redoButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//help event
			helpButton_onBeforeClick : function(e) {return true;},
			helpButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal back event
			modalBack_onBeforeClick : function(e) {return true;},
			modalBack_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att link event
			attLinkModal_onBeforeClick : function(e) {return true;},
			attLinkModal_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att link text input event
			attLinkText_onBeforeInput : function(e) {return true;},
			attLinkText_onAfterInput : function(e) {},
			attLinkText_onBeforeBlur : function(e) {return true;},
			attLinkText_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att link href input event
			attLinkHref_onBeforeInput : function(e) {return true;},
			attLinkHref_onAfterInput : function(e) {},
			attLinkHref_onBeforeBlur : function(e) {return true;},
			attLinkHref_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att link insert button event
			attLinkInsertButton_onBeforeClick : function(e) {return true;},
			attLinkInsertButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att file event
			attFileModal_onBeforeClick : function(e) {return true;},
			attFileModal_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att file upload button event
			attFileUploadButton_onBeforeClick : function(e) {return true;},
			attFileUploadButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att file upload div event
			attFileUploadDiv_onBeforeDragover : function(e) {return true;},
			attFileUploadDiv_onAfterDragover : function(e) {},
			attFileUploadDiv_onBeforeDrop : function(e) {return true;},
			attFileUploadDiv_onAfterDrop : function(e) {},
			attFileUploadDiv_onBeforeClick : function(e) {return true;},
			attFileUploadDiv_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att file upload input event
			attFileUpload_onBeforeInput : function(e) {return true;},
			attFileUpload_onAfterInput : function(e) {},
			attFileUpload_onBeforeBlur : function(e) {return true;},
			attFileUpload_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att file insert button event
			attFileInsertButton_onBeforeClick : function(e) {return true;},
			attFileInsertButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//att link tooltip edit button event
			attLinkTooltipEditButton_onBeforeClick : function(e) {return true;},
			attLinkTooltipEditButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//att link tooltip unlink button event
			attLinkTooltipUnlinkButton_onBeforeClick : function(e) {return true;},
			attLinkTooltipUnlinkButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att image event
			attImageModal_onBeforeClick : function(e) {return true;},
			attImageModal_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att image upload button and view event
			attImageUploadButtonAndView_onBeforeDragover : function(e) {return true;},
			attImageUploadButtonAndView_onAfterDragover : function(e) {},
			attImageUploadButtonAndView_onBeforeDrop : function(e) {return true;},
			attImageUploadButtonAndView_onAfterDrop : function(e) {},
			attImageUploadButtonAndView_onBeforeClick : function(e) {return true;},
			attImageUploadButtonAndView_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att image view pre button event
			attImageViewPreButtion_onBeforeClick : function(e) {return true;},
			attImageViewPreButtion_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att image view next button event
			attImageViewNextButtion_onBeforeClick : function(e) {return true;},
			attImageViewNextButtion_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att image upload input event
			attImageUpload_onBeforeInput : function(e) {return true;},
			attImageUpload_onAfterInput : function(e) {},
			attImageUpload_onBeforeBlur : function(e) {return true;},
			attImageUpload_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att image url input event
			attImageURL_onBeforeInput : function(e) {return true;},
			attImageURL_onAfterInput : function(e) {},
			attImageURL_onBeforeBlur : function(e) {return true;},
			attImageURL_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att image insert button event
			attImageInsertButton_onBeforeClick : function(e) {return true;},
			attImageInsertButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att video event
			attVideoModal_onBeforeClick : function(e) {return true;},
			attVideoModal_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal att video embed id input event
			attVideoEmbedId_onBeforeInput : function(e) {return true;},
			attVideoEmbedId_onAfterInput : function(e) {},
			attVideoEmbedId_onBeforeBlur : function(e) {return true;},
			attVideoEmbedId_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att video width input event
			attVideoWidth_onBeforeInput : function(e) {return true;},
			attVideoWidth_onAfterInput : function(e) {},
			attVideoWidth_onBeforeBlur : function(e) {return true;},
			attVideoWidth_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att video height input event
			attVideoHeight_onBeforeInput : function(e) {return true;},
			attVideoHeight_onAfterInput : function(e) {},
			attVideoHeight_onBeforeBlur : function(e) {return true;},
			attVideoHeight_onAfterBlur : function(e) {},
			
			//==================================================================================
			//modal att video insert button event
			attVideoInsertButton_onBeforeClick : function(e) {return true;},
			attVideoInsertButton_onAfterClick : function(e) {},
			
			//==================================================================================
			//att image tooltip width input event
			attImageAndVideoTooltipWidthInput_onBeforeInput : function(e) {return true;},
			attImageAndVideoTooltipWidthInput_onAfterInput : function(e) {},
			attImageAndVideoTooltipWidthInput_onBeforeBlur : function(e) {return true;},
			attImageAndVideoTooltipWidthInput_onAfterBlur : function(e) {},
			attImageAndVideoTooltipWidthInput_onBeforeKeyup : function(e) {return true;},
			attImageAndVideoTooltipWidthInput_onAfterKeyup : function(e) {},
			
			//==================================================================================
			//att image tooltip float none radio input event
			attImageAndVideoTooltipFloatRadioNone_onBeforeClick : function(e) {return true;},
			attImageAndVideoTooltipFloatRadioNone_onAfterClick : function(e) {},
			
			//==================================================================================
			//att image tooltip float left radio input event
			attImageAndVideoTooltipFloatRadioLeft_onBeforeClick : function(e) {return true;},
			attImageAndVideoTooltipFloatRadioLeft_onAfterClick : function(e) {},
			
			//==================================================================================
			//att image tooltip float right radio input event
			attImageAndVideoTooltipFloatRadioRight_onBeforeClick : function(e) {return true;},
			attImageAndVideoTooltipFloatRadioRight_onAfterClick : function(e) {},
			
			//==================================================================================
			//att image tooltip shape square radio input event
			attImageAndVideoTooltipShapeRadioSquare_onBeforeClick : function(e) {return true;},
			attImageAndVideoTooltipShapeRadioSquare_onAfterClick : function(e) {},
			
			//==================================================================================
			//att image tooltip shape radius radio input event
			attImageAndVideoTooltipShapeRadioRadius_onBeforeClick : function(e) {return true;},
			attImageAndVideoTooltipShapeRadioRadius_onAfterClick : function(e) {},
			
			//==================================================================================
			//att image tooltip shape circle radio input event
			attImageAndVideoTooltipShapeRadioCircle_onBeforeClick : function(e) {return true;},
			attImageAndVideoTooltipShapeRadioCircle_onAfterClick : function(e) {},
			
			//==================================================================================
			//modal help event
			helpModal_onBeforeClick : function(e) {return true;},
			helpModal_onAfterClick : function(e) {},
			
			//==================================================================================
			//placeholder event
			placeholder_onBeforeClick : function(e) {return true;},
			placeholder_onAfterClick : function(e) {},
		};
		//==================================================================================
		//element public event for css controll
		//==================================================================================
		this.cssEvents = {
			target_onBeforeClick : function(e) {return true;},
			target_onAfterClick : function(e) {},
			target_onBeforeMouseover : function(e) {return true;},
			target_onAfterMouseover : function(e) {},
			target_onBeforeMouseout : function(e) {return true;},
			target_onAfterMouseout : function(e) {},
			target_onBeforeTouchstart : function(e) {return true;},
			target_onAfterTouchstart : function(e) {},
			target_onBeforeTouchend : function(e) {return true;},
			target_onAfterTouchend : function(e) {},
		};
		//==================================================================================
		...
		//public functions
		//==================================================================================
		this._beforeAlert = function(message) {return true;}
	};
	return new Vanillanote();
};
//==================================================================================
//create vanilla note
//==================================================================================
function createVanillanote(Vanillanote) {
	...
	//element, variable
	var note, template, tool, textarea;
	var toolToggleButton, paragraphStyleSelect, paragraphStyleSelectBox, boldButton, underlineButton, italicButton;
	var ulButton, olButton, textAlignSelect, textAlignSelectBox
	var attLinkButton, attFileButton, attImageButton, attVideoButton;
	var fontSizeInputBox, fontSizeInput, letterSpacingInputBox, letterSpacingInput, lineHeightInputBox, lineHeightInput;
	var fontFamilySelect, fontFamilySelectBox, colorTextSelect, colorBackSelect
	var undoButton, redoButton, helpButton, formatClearButton;
	var colorTextSelectBox, colorText0, colorText1, colorText2, colorText3, colorText4, colorText5, colorText6, colorText7;
	var colorTextRInput, colorTextGInput, colorTextBInput, colorTextOpacityInput;
	var colorBackSelectBox, colorBack0, colorBack1, colorBack2, colorBack3, colorBack4, colorBack5, colorBack6, colorBack7;
	var colorBackRInput, colorBackGInput, colorBackBInput, colorBackOpacityInput;
	var modalBack, attLinkModal, attFileModal, attImageModal, attVideoModal, helpModal, helpMain, placeholder, placeholderColor, placeholderBackgroundColor;
	var attLinkText, attLinkHref, attLinkIsBlankCheckbox, attLinkValidCheckText, attLinkValidCheckbox, attLinkInsertButton;
  	var attFilelayout, attFileUploadButton, attFileUploadDiv, attFileUpload, attFileInsertButton;
  	var attImageUploadButtonAndView, attImageViewPreButtion, attImageViewNextButtion, attImageUpload, attImageURL, attImageInsertButton;
	var attLinkTooltip, attLinkTooltipHref, attLinkTooltipEditButton, attLinkTooltipUnlinkButton;
	var attVideoEmbedId, attVideoWidth, attVideoHeight, attVideoValidCheckText, attVideoValidCheckbox, attVideoInsertButton;
	var attImageAndVideoTooltip, attImageAndVideoTooltipWidthInput;
	var attImageAndVideoTooltipFloatRadioNone, attImageAndVideoTooltipFloatRadioLeft, attImageAndVideoTooltipFloatRadioRight;
	var attImageAndVideoTooltipShapeRadioSquare, attImageAndVideoTooltipShapeRadioRadius, attImageAndVideoTooltipShapeRadioCircle;
	var header;
	//colors
	var mainColor, colorSet, invertColor;
	//css
	var styleElement, cssKeys;
	var cssText = "";
	//icons
	var linkElementGoogleIcons, googleIcons;
	//attributes
	var noteModeByDevice, isNoteByMobile;
	var defaultFontSize, defaultLineHeight;
	var tempFontFamiliy, defaultFontFamilies, addFontFamilies, removeFontFamilies, defaultFontFamiliy;
	var sizeLevel, sizeLevelDesktop, sizeLevelMobile, textareaMaxWidth, textareaMaxHeight, textareaHeightIsModify;
	var defaultModalFontFamily
	var defaultAttImageAcceptTypes, attImageAcceptTypes;
	var placeholderTitle, placeholderTextContent;
	var usingParagraphStyle, usingBold, usingUnderline, usingItalic;
	var usingUl, usingOl, usingTextAlign;
	var usingAttLink, usingAttFile, usingAttImage, usingAttVideo;
	var usingFontSize, usingLetterSpacing, usingLineHeight;
	var usingFontFamily, usingColorText, usingColorBack, usingFormatClear;
	var usingUndo, usingRedo, usingHelp;
	
	//etc variable
	var tempElement1, tempElement2, tempElement3, tempText;
	...
	*/
	 ...
	 */
	var getPublicClassName = function(idx, className) {
	...
	* @returns {String} element className.
	*/
	var getClassName = function(idx, className) {
	...
	*/
	var getCssClassText = function(idx, className, cssObject) {
	...
	*/
	var getNoteIndex = function(el) {
		if(!el) return null;
		var noteIndex;
		var target = el instanceof Element ? el : el.parentNode;
	...
	*/
	var checkNumber = function(checkValue) {
		var regExp = /^[0-9]+$/;
	...
	*/
	var checkRealNumber = function(checkValue) {
	...
	*/
	var checkAlphabetAndNumber = function(checkValue) {
	...
	*/
	var checkHex = function(checkValue) {
	...
	*/
	var getCommaStrFromArr = function(arr) {
		var str = "";
	...
	*/
	var getObjectFromCssText = function(cssText) {
		...
		for(var i = 0; i < csses.length; i++) {
			...
			cssObject[css[0].trim()] = css[1].trim();
		}
	...
	* Example: {"font-weight":"bold","text-align":"center"} > "font-weight:bold;text-align:center;"
	*/
	var getCssTextFromObject = function(cssObject) {
		var cssText = "";
	...
	*/
	var getAttributesObjectFromElement = function(element) {
		var attriesObject = new Object();
		if(!element.attributes) return attriesObject;
		
		for(var i = 0; i < element.attributes.length; i++) {
			attriesObject[element.attributes[i].nodeName] = element.attributes[i].nodeValue
		}
	...
	*/
	var setAttributesObjectToElement = function(element, attributes) {
	...
	*/
	var compareAttributesBetweenEl = function(el1, el2) {
	...
	*/
	var compareStylesBetweenEl = function(el1, el2) {
	    var style1 = el1.cssText;
	    var style2 = el2.cssText;
	...
	*/
	var getExtractColorValue = function(hexColor, channel) {
		if(!hexColor || !channel) {
			return "33";
		}
	...
	*/
	var getRGBAFromHex = function(hexColor, opacity) {
	...
	*/
	var getHexFromRGBA = function(color) {
	    if (color.startsWith("#")) {
	    ...
	    var rgba = color.match(/\d+/g).map(Number); 
	...
	*/
	var getOpacityFromRGBA = function(color) {
	...
	*/
	var getHexColorFromColorName = function(colorName) {
	...
	*/
	var getColorShade = function(hexColor) {
	...
	*/
	var getAdjustHexColor = function(color, diff) {
		if (color.startsWith("#")) {
			color = color.slice(1);
		}
		...
		var r = parseInt(color.slice(0, 2), 16) + diffValue;
		var g = parseInt(color.slice(2, 4), 16) + diffValue;
		var b = parseInt(color.slice(4, 6), 16) + diffValue;
	...
	*/
	var getInvertColor = function(hex) {
		if (hex.startsWith("#")) {
			hex = hex.slice(1);
		}
	...
	*/
	var isCloserToRight = function(element) {
	...
	*/
	var onEventDisable = function(type) {
		var interval
		if(type === "resize") {
	...
	*/
	var replaceDifferentBetweenElements = function(oldEl, newEl) {
		var newStartNode;
		var newEndNode;
		var tempEl;
		
		// Compares the two elements and modifies the different parts.
		var replaceElements = function(el1, el2) {
			if (el1.tagName !== (Vanillanote.variables.noteName+"-textarea").toUpperCase()
				...
				el1.parentNode.replaceChild(tempEl, el1);
	...
	*/
	var handleSpecialTagSelection = function(noteIndex) {
	...
	*/
	var isFontAvailable = function(fontName) {
	...
	*/
	var setNewSelection = function(startNode, startOffset, endNode, endOffset) {
	...
	*/
	var setOriginEditSelection = function(noteIndex) {
	...
	*/
	var setEditSelection = function(noteIndex, selection) {
		...
		if(Vanillanote.variables.editStartNodes[noteIndex] instanceof Element) {
			while(Vanillanote.variables.editStartNodes[noteIndex] instanceof Element) {
				...
				if(Vanillanote.variables.editStartNodes[noteIndex].firstChild.tagName === "BR") break;	//no br
		...
		if(Vanillanote.variables.editEndNodes[noteIndex] instanceof Element) {
			while(Vanillanote.variables.editEndNodes[noteIndex] instanceof Element) {
				...
				if(Vanillanote.variables.editEndNodes[noteIndex].firstChild.tagName === "BR") break;	//no br
		...
		if(Vanillanote.consts.UNIT_TAG.indexOf(Vanillanote.variables.editStartElements[noteIndex].tagName) > 0) {
			while(Vanillanote.consts.UNIT_TAG.indexOf(Vanillanote.variables.editStartElements[noteIndex].tagName) > 0) {
				Vanillanote.variables.editStartElements[noteIndex] = Vanillanote.variables.editStartElements[noteIndex].firstChild;
			}
		}
		// If the end element is a unit element, find the deepest child unit element.
		if(Vanillanote.consts.UNIT_TAG.indexOf(Vanillanote.variables.editEndElements[noteIndex].tagName) > 0) {
			while(Vanillanote.consts.UNIT_TAG.indexOf(Vanillanote.variables.editEndElements[noteIndex].tagName) > 0) {
				Vanillanote.variables.editEndElements[noteIndex] = Vanillanote.variables.editEndElements[noteIndex].lastChild;
			}
		}
		...
		if(Vanillanote.variables.editStartElements[noteIndex].tagName === (Vanillanote.variables.noteName+"-textarea").toUpperCase()) {
			Vanillanote.variables.editStartElements[noteIndex] = null;
		}
		//If the end element is textarea, be end element to null
		if(Vanillanote.variables.editEndElements[noteIndex].tagName === (Vanillanote.variables.noteName+"-textarea").toUpperCase()) {
	 ...
	 */
	var isValidSelection =  function(noteIndex) {
	...
	*/
	var getParentUnitTagElemnt = function(el) {
		var element = el;
		while(element) {
	...
	*/
	var getParentTagName = function(el) {
		var tagName = "span";
	...
	*/
	var getObjectEditElementAttributes = function(el) {
		var attributesObject = getAttributesObjectFromElement(el); 
		// Helper function to check and add attributes from the element.
		var chkElementAttributes = function(element) {
			if(element.getAttribute) {
				var cssTempObject = getAttributesObjectFromElement(element);
	...
	*/
	var getObjectEditElementCss = function(el) {
		var cssObject = getObjectFromCssText(document.contains(el) && el.getAttribute ? el.getAttribute("style") : ""); 
		
		var chkElementStyle = function(element) {
			if(element.getAttribute) {
				var cssTempObject = getObjectFromCssText(element.getAttribute("style"));
				var cssTempObjectKeys = Object.keys(cssTempObject);
				for(var i = 0; i < cssTempObjectKeys.length; i++) {
	...
	*/
	var getEditElementTag = function(noteIndex) {
		var rtnTagName = "";
		var tempTagName = "";
		for(var i = 0; i < Vanillanote.variables.editDragUnitElements[noteIndex].length; i++) {
			if(Vanillanote.variables.editDragUnitElements[noteIndex][i].tagName === "LI") {
				tempTagName = Vanillanote.variables.editDragUnitElements[noteIndex][i].parentNode.tagName;
			}
			else {
				tempTagName = Vanillanote.variables.editDragUnitElements[noteIndex][i].tagName;
			}
	...
	*/
	var getPreviousElementsUntilNotTag = function(startEl, tag) {
		var previouses = [];
	...
	*/
	var getNextElementsUntilNotTag = function(startEl, tag) {
		var nexts = [];
	    var next = startEl;
	    var attributes = getAttributesObjectFromElement(startEl);
	    nexts.push(next);
	...
	*/
	var setVariableButtonTogle = function(noteIndex, cssObject) {
		//bold
	...
	*/
	var setTagToggle = function(noteIndex, tag) {
		if(tag === "UL") {
	...
	*/
	var button_onToggle = function(target, toggle) {
	...
	*/
	var allButtonToggle = function(noteIndex) {
		//format
		...
		//color
		Vanillanote.elements.colorTextSelects[noteIndex].querySelector("."+getEventChildrenClassName()).style.color
		...
		Vanillanote.elements.colorBackSelects[noteIndex].querySelector("."+getEventChildrenClassName()).style.color
	...
	*/
	var initToggleButtonVariables = function(noteIndex) {
		Vanillanote.variables.boldToggles[noteIndex] = false;
		Vanillanote.variables.underlineToggles[noteIndex] = false;
		Vanillanote.variables.italicToggles[noteIndex] = false;
		Vanillanote.variables.ulToggles[noteIndex] = false;
	...
	*/
	var selectToggle = function(target) {
		// If a child element is selected, event is controlled
		if(target.classList.contains(getEventChildrenClassName())) {
			target = target.parentNode;
		}
	...
	*/
	var closeAllSelectBoxes = function(noteIndex) {
		var displayBlock = getId(noteIndex, "on_display_block");
		var displayNone = getId(noteIndex, "on_display_none");
	...
	*/
	var fontFamilySelectList_onClick = function(e) {
		if(!e.target) return;
		...
		var oldStyleObject = getObjectFromCssText(Vanillanote.elements.fontFamilySelects[noteIndex].getAttribute("style"));
		...
		Vanillanote.elements.fontFamilySelects[noteIndex].firstChild.textContent = fontFamily.length > 12 ? fontFamily.substr(0,12) + "..." : fontFamily;
		Vanillanote.elements.fontFamilySelects[noteIndex].style.fontFamily = fontFamily;
	};
	...
	*/
	var getObjectNoteCss = function(noteIndex) {
		var cssObject = new Object();
	...
	* @param {Number} noteIndex - The index of the note.
	*/
	var setEditStyleTag = function(noteIndex) {
		if(Vanillanote.variables.setEditStyleTagToggle > 0) {
			Vanillanote.variables.setEditStyleTagToggle--;
			return;
		}
		var tempEl = Vanillanote.variables.editStartUnitElements[noteIndex];
		var textarea = tempEl;
		while(tempEl) {
		...
		if(Vanillanote.variables.editStartNodes[noteIndex] !== Vanillanote.variables.editEndNodes[noteIndex]) {
			...
			var isCheck = false;
			var isEnd = false;
			var getCheckAllStyle = function(element) {
	...
	*/
	var isInTextarea = function() {
		...
		var textarea = range.startContainer.parentNode;
	...
	*/
	var getElementReplaceTag = function(element, tag) {
		...
		tempEl = setAttributesObjectToElement(tempEl, getAttributesObjectFromElement(element));
		return tempEl;
	};
	...
	*/
	var removeDoubleTag = function(noteIndex, element) {
	...
	*/
	var getElement = function(text, tagName, cssText, attributes) {
	...
	*/
	var setEditNodeAndElement = function(noteIndex, setElement, compareElement) {
		var isChange = false;
	...
	*/
	var modifySeletedElements = function(noteIndex) {
		var isEnd = false;
	...
	*/
	var modifySelectedUnitElementTag = function(target) {
		var noteIndex = getNoteIndex(target);
		if(!noteIndex) return;
		...
		if(Vanillanote.consts.DOUBLE_TAG.indexOf(tag) >= 0) { // ul or ol
			...
			for(var i = 0; i < Vanillanote.variables.editDragUnitElements[noteIndex].length; i++) {
				if(Vanillanote.variables.editDragUnitElements[noteIndex][i].tagName === "LI") {
					// Remove ul or ol tag
					removeDoubleTag(noteIndex, Vanillanote.variables.editDragUnitElements[noteIndex][i].parentNode);
				}
				...
				if(i === 0) {
					Vanillanote.variables.editDragUnitElements[noteIndex][0].insertAdjacentElement("beforebegin", tempDoubleElement);
				}
				...
				Vanillanote.variables.editDragUnitElements[noteIndex][i].remove();
			...
			for(var i = 0; i < Vanillanote.variables.editDragUnitElements[noteIndex].length; i++) {
				...
				Vanillanote.variables.editDragUnitElements[noteIndex][i].replaceWith(tempEl);
				Vanillanote.variables.editDragUnitElements[noteIndex][i] = tempEl;
			}
		}
		...
		var newEndOffset = Vanillanote.variables.editEndElements[noteIndex] ? Vanillanote.variables.editEndElements[noteIndex].textContent.length : 0
	...
	*/
	var modifySelectedUnitElementStyle = function(target) {
		var noteIndex = getNoteIndex(target);
		if(!noteIndex) return;
		if(!isValidSelection(noteIndex)) return;
		...
		for(var i = 0; i < Vanillanote.variables.editDragUnitElements[noteIndex].length; i++) {
			nowCssText = Vanillanote.variables.editDragUnitElements[noteIndex][i].getAttribute("style");
			...
			tempEl = Vanillanote.variables.editDragUnitElements[noteIndex][i].cloneNode(true);
			tempEl.setAttribute("style",newCssText);
			Vanillanote.variables.editDragUnitElements[noteIndex][i].parentNode.replaceChild(tempEl, Vanillanote.variables.editDragUnitElements[noteIndex][i]);
			Vanillanote.variables.editDragUnitElements[noteIndex][i] = tempEl;
		}
		
		// Sets the new selection range.
		var newStartOffset = 0
		var newEndOffset = Vanillanote.variables.editEndElements[noteIndex].childNodes ? Vanillanote.variables.editEndElements[noteIndex].childNodes.length : 0
		// Sets the new selection range.
		setNewSelection(
				Vanillanote.variables.editDragUnitElements[noteIndex][0],
				0,
				Vanillanote.variables.editDragUnitElements[noteIndex][Vanillanote.variables.editDragUnitElements[noteIndex].length - 1],
				1
				);
	};
	 ...
	 */
	var modifySelectedSingleElement = function(noteIndex, csses, tagName, attributes) {
		if(!isValidSelection(noteIndex)) return;
		...
		var sS = Vanillanote.variables.editStartNodes[noteIndex].textContent.slice(0,Vanillanote.variables.startOffsets[noteIndex]);
		// Text content after the starting node of the selection.
		var sE = Vanillanote.variables.editStartNodes[noteIndex].textContent.slice(Vanillanote.variables.startOffsets[noteIndex],Vanillanote.variables.editStartNodes[noteIndex].textContent.length);
		// Text content before the ending node of the selection.
		var eS = Vanillanote.variables.editEndNodes[noteIndex].textContent.slice(0,Vanillanote.variables.endOffsets[noteIndex]);
		// Text content after the ending node of the selection.
		var eE = Vanillanote.variables.editEndNodes[noteIndex].textContent.slice(Vanillanote.variables.endOffsets[noteIndex],Vanillanote.variables.editEndNodes[noteIndex].textContent.length);
		
		// An internal function used for inserting nodes.
		var insertSelectedNode = function(tempEl, tempUnitEl) {
			if(!tempEl) return;
			if(tempUnitEl) {
				tempUnitEl.insertBefore(tempEl, null);
			}
			else {
				Vanillanote.variables.editStartUnitElements[noteIndex].insertBefore(tempEl, null);
			}
		}
		...
		for(var i = 0; i < selectedNodes.length; i++) {
			if(selectedNodes[i].nodeType === 3) {	// A comment indicating that the subsequent code handles text nodes in the selection.
				...
				if (tempEl && tempEl.tagName.substring(0, 1) === "H") {
					csses = getObjectFromCssText(newCssText);
					delete csses["font-size"];
					delete csses["letter-spacing"];
					delete csses["line-height"];
					newCssText = getCssTextFromObject(csses);
	...
	*/
	var textarea_onBeforeinputSpelling = function(e) {
		...
		if (Vanillanote.variables.editStartUnitElements[noteIndex].tagName.substring(0, 1) === "H") {
			...
			if(Vanillanote.variables.editStartElements[noteIndex] instanceof Element
				&& Vanillanote.consts.UNIT_TAG.indexOf(Vanillanote.variables.editStartElements[noteIndex].tagName) < 0
		...
		if(Vanillanote.variables.editRanges[noteIndex].collapsed) {
			Vanillanote.variables.editRanges[noteIndex].insertNode(selectElement);
			...
			// Sets the new selection range.
			setNewSelection(newSelectElement.firstChild, 0, newSelectElement.firstChild, newSelectElement.firstChild.length);
		}
		else {
			// Modify the style of the selected element.
			modifySelectedSingleElement(noteIndex, getObjectNoteCss(noteIndex));
	...
	*/
	var textarea_onKeydownEnter = function(target) {
		var noteIndex = getNoteIndex(target);
		if(!noteIndex) return;
		if(!isValidSelection(noteIndex)) return;
		if(Vanillanote.variables.editStartUnitElements[noteIndex] && Vanillanote.variables.editStartUnitElements[noteIndex].textContent) {
			return;
		}
		// Ignore if it is an empty-able tag (except BR, img, input).
		if(Vanillanote.variables.editStartNodes[noteIndex] instanceof Element
			&& Vanillanote.consts.EMPTY_ABLE_TAG.indexOf(Vanillanote.variables.editStartNodes[noteIndex].tagName) >= 0
			&& Vanillanote.variables.editStartNodes[noteIndex].tagName !== "BR") {
			return;
		}
		var tempEl1;
		var tempEl2;
		var tagName = Vanillanote.variables.editStartUnitElements[noteIndex].tagName;
		tempEl1 = document.createElement(tagName);
		tempEl2 = document.createElement("BR");
		tempEl1.appendChild(tempEl2);
		tempEl1 = setAttributesObjectToElement(tempEl1, getAttributesObjectFromElement(Vanillanote.variables.editStartUnitElements[noteIndex]));
		
		Vanillanote.variables.editStartUnitElements[noteIndex].replaceWith(tempEl1);
	...
	*/
	var removeEmptyElment = function(el) {
	...
	*/
	var editUnitCheck = function(textarea) {
	...
	* @param {Element} textarea - The textarea element representing the editor.
	*/
	var doEditUnitCheck = function(noteIndex) {
	...
	*/
	var setElementScroll = function(parentElement, childElement) {
	...
	*/
	var decreaseTextareaHeight = function(textarea, noteIndex) {
	...
	* @param {HTMLTextAreaElement} textarea - The textarea element to be resized.
	*/
	var increaseTextareaHeight = function(textarea) {
	...
	*/
	var getCheckSelectBoxesOpened = function(noteIndex) {
		var displayBlock = getId(noteIndex, "on_display_block");
	...
	*/
	var closeAllModal = function(noteIndex) {
		var displayBlock = getId(noteIndex, "on_display_block");
		var displayNone = getId(noteIndex, "on_display_none");
	...
	*/
	var openAttLinkModal = function(noteIndex) {
		...
		var attLinkText = Vanillanote.elements.attLinkTexts[noteIndex];
		var attLinkHref = Vanillanote.elements.attLinkHrefs[noteIndex];
	...
	*/
	var openPlaceholder = function(noteIndex) {
		if(Vanillanote.variables.placeholderIsVisible[noteIndex]
			...
			&& Vanillanote.elements.textareas[noteIndex].childNodes[0].childNodes[0].tagName === "BR"
		) {
	...
	* @param {Number} noteIndex - The index of the note where the placeholder is located.
	*/
	var closePlaceholder = function(noteIndex) {
		if(Vanillanote.variables.placeholderIsVisible[noteIndex]) {
	...
	* @param {Number} noteIndex - The index of the note where the modals are located.
	*/
	var setAllModalSize = function(noteIndex) {
	...
	*/
	var setPlaceholderSize = function(noteIndex) {
		// Use setTimeout to adjust size according to the dynamic change in textarea's size.
		setTimeout(function() {
	...
	*/
	var setAllToolTipPosition = function(noteIndex) {
	...
	*/
	var closeAllTooltip = function(noteIndex) {
	...
	*/
	var appearAttLinkToolTip = function(noteIndex) {
        var a = Vanillanote.variables.editStartNodes[noteIndex].parentElement;
	...
	* @param {number} noteIndex - The index of the note in which the tooltip should appear.
	*/
	var appearAttImageAndVideoTooltip = function(noteIndex) {
		var img = Vanillanote.variables.editStartNodes[noteIndex];
		var cssObj = getObjectFromCssText(getAttributesObjectFromElement(img)["style"]);
		//width
		if(cssObj["width"]) {
			Vanillanote.elements.attImageAndVideoTooltipWidthInputs[noteIndex].value = extractNumber(cssObj["width"]);
		}
		//float
		switch(cssObj["float"]) {
        case "left":
        	Vanillanote.elements.attImageAndVideoTooltipFloatRadioLefts[noteIndex].checked = true;
			break;
        case "right":
        	Vanillanote.elements.attImageAndVideoTooltipFloatRadioRights[noteIndex].checked = true;
			break;
		default :
			Vanillanote.elements.attImageAndVideoTooltipFloatRadioNones[noteIndex].checked = true;
			break;
		}
		//shape
		Vanillanote.elements.attImageAndVideoTooltipShapeRadioSquares[noteIndex].checked = true;
		if(cssObj["border-radius"]) {
			var borderRadius = extractNumber(cssObj["border-radius"]);
			if(borderRadius > 0) {
				Vanillanote.elements.attImageAndVideoTooltipShapeRadioRadiuses[noteIndex].checked = true;
			}
			else if(borderRadius >= 50) {
				Vanillanote.elements.attImageAndVideoTooltipShapeRadioCircles[noteIndex].checked = true;
			}
		}
	...
	*/
	var setImageAndVideoWidth = function(el) {
		if(!el.value) el.value = 100;
		var widthPer = el.value;
		var noteIndex = getNoteIndex(el);
		if(!noteIndex) return;
		var imgNode = Vanillanote.variables.editStartNodes[noteIndex];
		...
		Vanillanote.variables.editStartNodes[noteIndex].parentNode.replaceChild(imgNode, Vanillanote.variables.editStartNodes[noteIndex]);
	...
	*/
	var isElementInParentBounds = function(parent, child) {
	...
	*/
	var setAllToolSize = function(noteIndex) {
		var toolButtons =  Vanillanote.elements.tools[noteIndex].childNodes;
	...
	*/
	var initAttLink = function(noteIndex) {
		Vanillanote.elements.attLinkTexts[noteIndex].value = "";
		Vanillanote.elements.attLinkHrefs[noteIndex].value = "";
		Vanillanote.elements.attLinkIsBlankCheckboxes[noteIndex].checked = false;
	};
	...
	*/
	var validCheckAttLink = function(noteIndex) {
		if(!Vanillanote.elements.attLinkTexts[noteIndex].value) {
			Vanillanote.elements.attLinkValidCheckboxes[noteIndex].checked = false;
		...
		if(!Vanillanote.elements.attLinkHrefs[noteIndex].value) {
			Vanillanote.elements.attLinkValidCheckboxes[noteIndex].checked = false;
			Vanillanote.elements.attLinkValidCheckTexts[noteIndex].style.color = getHexColorFromColorName(Vanillanote.colors.color9[noteIndex]);
		...
		Vanillanote.elements.attLinkValidCheckboxes[noteIndex].checked = true;
	...
	*/
	var validCheckAttVideo = function(noteIndex) {
		if(!Vanillanote.elements.attVideoEmbedIds[noteIndex].value) {
			Vanillanote.elements.attVideoValidCheckboxes[noteIndex].checked = false;
		...
		Vanillanote.elements.attVideoValidCheckboxes[noteIndex].checked = true;
	...
	*/
	var setAttTempFileValid = function(noteIndex) {
		var newAttTempFiles = new Object;
	...
	*/
	var setAttFileUploadDiv = function(noteIndex) {
		if(Vanillanote.variables.attTempFiles[noteIndex].length <= 0) {
	...
	*/
	var setAttTempImageValid = function(noteIndex) {
		var newAttTempImages = new Object;
	...
	*/
	var setAttImageUploadAndView = function(noteIndex) {
		var keys = Object.keys(Vanillanote.variables.attTempImages[noteIndex]);
	    ...
	    Vanillanote.elements.attImageURLs[noteIndex].value = "";
	...
	*/
	var initAttImage = function(noteIndex) {
		delete Vanillanote.variables.attTempImages[noteIndex];
		Vanillanote.variables.attTempImages[noteIndex] = new Object;
		Vanillanote.elements.attImageUploadButtonAndViews[noteIndex].replaceChildren();
		...
		Vanillanote.elements.attImageUploads[noteIndex].value = "";
		Vanillanote.elements.attImageURLs[noteIndex].value = "";
	...
	var target_onMouseover = function(e) {
		var target = e.target;
		// If a child element is selected, event is controlled
		if(target.classList.contains(Vanillanote.variables.noteName + "_eventChildren")) {
			target = target.parentNode;
	...
	var target_onMouseout = function(e) {
		var target = e.target;
		// If a child element is selected, event is controlled
		if(target.classList.contains(Vanillanote.variables.noteName + "_eventChildren")) {
			target = target.parentNode;
	...
	var target_onTouchstart = function(e) {
		var target = e.target;
		// If a child element is selected, event is controlled
		if(target.classList.contains(Vanillanote.variables.noteName + "_eventChildren")) {
			target = target.parentNode;
	...
	var target_onTouchend = function(e) {
		var target = e.target;
		// If a child element is selected, event is controlled
		if(target.classList.contains(Vanillanote.variables.noteName + "_eventChildren")) {
			target = target.parentNode;
	...
	var doDecreaseTextareaHeight = function(textarea, noteIndex) {
	...
	var modifyTextareaScroll = function(textarea, noteIndex) {
		// Stop if not in auto-scroll mode.
		if(!Vanillanote.variables.useMobileActiveMode[noteIndex]) return;
		...
		setTimeout(function() {
			...
			var heightSumDragUnitElements = Vanillanote.variables.editDragUnitElements[noteIndex][Vanillanote.variables.editDragUnitElements[noteIndex].length - 1].offsetTop
			- Vanillanote.variables.editDragUnitElements[noteIndex][0].offsetTop
			+ Vanillanote.variables.editDragUnitElements[noteIndex][Vanillanote.variables.editDragUnitElements[noteIndex].length - 1].offsetHeight;
	...
	var elementsEvent = {
		...
		note_observer : new MutationObserver(function(mutations) {
			...
			if(Vanillanote.variables.recodeNotes[noteIndex].length >= Vanillanote.variables.recodeLimit[noteIndex]) {
				...
				Vanillanote.variables.recodeNotes[noteIndex].push(Vanillanote.elements.textareas[noteIndex].cloneNode(true));
			}
			else {
		...
		window_resizeViewport : function(e) {
		...
		//==================================================================================
		//toolToggleButton event
		toolToggleButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var icon = Vanillanote.elements.toolToggleButtons[noteIndex].firstChild;
			//toggle
		...
		//==================================================================================
		//paragraphStyleSelect event
		paragraphStyleSelect_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		//==================================================================================
		//styleHeader1 event
		styleHeader1_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//styleHeader2 event
		styleHeader2_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//styleHeader3 event
		styleHeader3_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//styleHeader4 event
		styleHeader4_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//styleHeader5 event
		styleHeader5_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//styleHeader6 event
		styleHeader6_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		boldButton_onClick : function(e) {
			...
			if(Vanillanote.variables.editRanges[noteIndex] && Vanillanote.variables.editRanges[noteIndex].collapsed) {
		...
		//==================================================================================
		//underlineButton event
		underlineButton_onClick : function(e) {
			// Toggle the button
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		//==================================================================================
		//italic
		italicButton_onClick : function(e) {
			// Toggle the button
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		//==================================================================================
		//text-align
		textAlignSelect_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			selectToggle(e.target);
			// It's too inconvenient if the cursor is caught again on mobile..
		...
		//==================================================================================
		//text-align-left
		textAlignLeft_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//text-align-center
		textAlignCenter_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//text-align-right
		textAlignRight_onClick : function(e) {
			// If a child element is selected, event is controlled
			var target = e.target;
			if(target.classList.contains(getEventChildrenClassName())) {
				target = target.parentNode;
		...
		//==================================================================================
		//att link
		attLinkButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			//att madal open
		...
		//==================================================================================
		//modal att link
		attLinkModal_onClick : function(e) {
		},
		//modal att link text
		attLinkText_onInput : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			validCheckAttLink(noteIndex);
		},
		attLinkText_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			validCheckAttLink(noteIndex);
		},
		//modal att link href
		attLinkHref_onInput : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			validCheckAttLink(noteIndex);
		},
		attLinkHref_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			validCheckAttLink(noteIndex);
		},
		//modal att link insert
		attLinkInsertButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!isValidSelection(noteIndex)) {
				closeAllModal(noteIndex);
			...
			var attLinkValidCheckbox = Vanillanote.elements.attLinkValidCheckboxes[noteIndex];
			if(!attLinkValidCheckbox.checked) {
				return;
			}
			var attLinkText = Vanillanote.elements.attLinkTexts[noteIndex];
			var attLinkHref = Vanillanote.elements.attLinkHrefs[noteIndex];
			var attIsblank = Vanillanote.elements.attLinkIsBlankCheckboxes[noteIndex];
			...
			if(Vanillanote.variables.editRanges[noteIndex].collapsed) {
				...
				Vanillanote.variables.editRanges[noteIndex].insertNode(tempEl);
                setNewSelection(
                    tempEl,
                    1,
                    tempEl,
		...
		//att link tooltip
		//edit button
		attLinkTooltipEditButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		//unlink button
		attLinkTooltipUnlinkButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var previousElements = getPreviousElementsUntilNotTag(Vanillanote.variables.editStartElements[noteIndex], "A");
			var nextElements = getNextElementsUntilNotTag(Vanillanote.variables.editStartElements[noteIndex], "A");
		...
		//==================================================================================
		//att file
		attFileButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
    	...
    	//==================================================================================
		//modal att file
    	attFileModal_onClick : function(e) {
		},
	    //modal att file upload button
	    attFileUploadButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			Vanillanote.elements.attFileUploads[noteIndex].click();
	    },
	    //modal att file upload div
	    attFileUploadDiv_onDragover : function(e) {
	        e.stopPropagation();
	        e.preventDefault();
	        e.dataTransfer.dropEffect = "copy";
	    },
	    attFileUploadDiv_onDrop : function(e) {
	        e.preventDefault();
	        var noteIndex = getNoteIndex(e.target);
	        if(!noteIndex) return;
	        ...
	        for(var i = 0; i < files.length; i++){
	            Vanillanote.variables.attTempFiles[noteIndex][getUUID()] = files[i];
	        }
	    ...
	    attFileUploadDiv_onClick : function(e) {
		...
		attFileUpload_onInput : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		attFileUpload_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		},
		//modal att file insert
		attFileInsertButton_onClick : function(e) {
			/*
			If there's a range
			...
			*/
			...
			var editStartUnitElements = Vanillanote.variables.editStartUnitElements[noteIndex];
			var tempEl1;
			var tempEl2;
			var selectEl;
		...
		//==================================================================================
		//att image
		attImageButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
    	...
    	//==================================================================================
		//modal att image
    	attImageModal_onClick : function(e) {
		},
		//modalatt image uplaod button and view
	    attImageUploadButtonAndView_onDragover : function(e) {
	        e.stopPropagation();
	        e.preventDefault();
	        e.dataTransfer.dropEffect = "copy";
	    },
	    attImageUploadButtonAndView_onDrop : function(e) {
	        e.preventDefault();
	        var noteIndex = getNoteIndex(e.target);
	        if(!noteIndex) return;
	        var files = Array.from(e.dataTransfer.files);
	        for(var i = 0; i < files.length; i++){
	            Vanillanote.variables.attTempImages[noteIndex][getUUID()] = files[i];
	        }
	    ...
	    attImageUploadButtonAndView_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			Vanillanote.elements.attImageUploads[noteIndex].click();
	    },
		//modal att image view pre button
		attImageViewPreButtion_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		attImageViewNextButtion_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var scrollAmount = Vanillanote.elements.attImageUploadButtonAndViews[noteIndex].offsetWidth / 1.5 + 10;
			Vanillanote.elements.attImageUploadButtonAndViews[noteIndex].scrollLeft += scrollAmount;
		...
		attImageUpload_onInput : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var files = Array.from(e.target.files);
	        for(var i = 0; i < files.length; i++){
		...
		attImageUpload_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		},
		//modal att image url
		attImageURL_onInput : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		attImageURL_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		},
		//modal att image insert
		attImageInsertButton_onClick : function(e) {
			/*
			...
			*/
			...
			if(Vanillanote.elements.attImageURLs[noteIndex].value) {
				var url = Vanillanote.elements.attImageURLs[noteIndex].value;
				var editStartUnitElements = Vanillanote.variables.editStartUnitElements[noteIndex];
				var tempEl1;
				var tempEl2;
		...
		//==================================================================================
		//att video
		attVideoButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			...
			//modal setting
			Vanillanote.elements.attVideoEmbedIds[noteIndex].value = "";
			Vanillanote.elements.attVideoWidthes[noteIndex].value = 100;
			Vanillanote.elements.attVideoHeights[noteIndex].value = 500;

			validCheckAttVideo(noteIndex);
		},
    	//==================================================================================
		//modal att video
    	attVideoModal_onClick : function(e) {
		},
		//modal att video embed id
		attVideoEmbedId_onInput : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			validCheckAttVideo(noteIndex);
		},
		attVideoEmbedId_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			validCheckAttVideo(noteIndex);
		},
		//modal att video width
		attVideoWidth_onInput : function(e) {
		...
		attVideoWidth_onBlur : function(e) {
		...
		attVideoHeight_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			if(!checkNumber(inputValue)) {
				e.target.value = "";
		...
		attVideoHeight_onBlur : function(e) {
		...
		attVideoInsertButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!isValidSelection(noteIndex)) {
				closeAllModal(noteIndex);
			...
			var attVideoValidCheckbox = Vanillanote.elements.attVideoValidCheckboxes[noteIndex];
			...
			if(Vanillanote.elements.attVideoEmbedIds[noteIndex].value) {
				var src = "https://www.youtube.com/embed/" + Vanillanote.elements.attVideoEmbedIds[noteIndex].value;
				var editStartUnitElements = Vanillanote.variables.editStartUnitElements[noteIndex];
				var tempEl1;
				var tempEl2;
				var viewerStyle = "overflow:hidden;"
									+ "width:" + Vanillanote.elements.attVideoWidthes[noteIndex].value + "%;"
									+ "height:" + Vanillanote.elements.attVideoHeights[noteIndex].value + "px;";
		...
		//==================================================================================
		//att image tooltip width input event
		attImageAndVideoTooltipWidthInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			if(!checkNumber(inputValue)) {
				e.target.value = "";
		...
		attImageAndVideoTooltipWidthInput_onBlur : function(e) {
			setImageAndVideoWidth(e.target);
		},
		attImageAndVideoTooltipWidthInput_onKeyup : function(e) {
			if(e.key === "Enter") {
				setImageAndVideoWidth(e.target);
			}
		},
		//att image tooltip float radio none input event
		attImageAndVideoTooltipFloatRadioNone_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var imgNode = Vanillanote.variables.editStartNodes[noteIndex].cloneNode(true);
			if(imgNode.tagName !== "IMG" && imgNode.tagName !== "IFRAME") return;
		...
		attImageAndVideoTooltipFloatRadioLeft_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var imgNode = Vanillanote.variables.editStartNodes[noteIndex].cloneNode(true);
			if(imgNode.tagName !== "IMG" && imgNode.tagName !== "IFRAME") return;
		...
		attImageAndVideoTooltipFloatRadioRight_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var imgNode = Vanillanote.variables.editStartNodes[noteIndex].cloneNode(true);
			if(imgNode.tagName !== "IMG" && imgNode.tagName !== "IFRAME") return;
		...
		//att image tooltip shape square radio input event
		attImageAndVideoTooltipShapeRadioSquare_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var imgNode = Vanillanote.variables.editStartNodes[noteIndex];
			if(imgNode.tagName !== "IMG" && imgNode.tagName !== "IFRAME") return;
		...
		//att image tooltip shape radius radio input event
		attImageAndVideoTooltipShapeRadioRadius_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var imgNode = Vanillanote.variables.editStartNodes[noteIndex];
			if(imgNode.tagName !== "IMG" && imgNode.tagName !== "IFRAME") return;
		...
		//att image tooltip shape circle radio input event
		attImageAndVideoTooltipShapeRadioCircle_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			var imgNode = Vanillanote.variables.editStartNodes[noteIndex];
			if(imgNode.tagName !== "IMG" && imgNode.tagName !== "IFRAME") return;
		...
		//==================================================================================
		//fontSizeInputBox event
		fontSizeInputBox_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			// If the selection is a single point
			if(Vanillanote.variables.editRanges[noteIndex] && Vanillanote.variables.editRanges[noteIndex].collapsed) {
		...
		//fontSizeInput event
		fontSizeInput_onClick : function(e) {
		},
		fontSizeInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		fontSizeInput_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!e.target.value) {
		...
		//==================================================================================
		//letterSpacingInputBox event
		letterSpacingInputBox_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			// If the selection is a single point
			if(Vanillanote.variables.editRanges[noteIndex] && Vanillanote.variables.editRanges[noteIndex].collapsed) {
		...
		//letterSpacingInput event
		letterSpacingInput_onClick : function(e) {
		},
		letterSpacingInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		letterSpacingInput_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!e.target.value) {
				e.target.value = "0";
		...
		//==================================================================================
		//lineHeightInputBox event
		lineHeightInputBox_onClick : function(e) {
		},
		lineHeightInputBox_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		//lineHeightInput event
		lineHeightInput_onClick : function(e) {
		},
		lineHeightInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		lineHeightInput_onBlur : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!e.target.value) {
		...
		//==================================================================================
		//fontFamilySelect event
		fontFamilySelect_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			selectToggle(e.target);
			// It's too inconvenient if the cursor is caught again on mobile..
		...
		//==================================================================================
		//color text select
		colorTextSelect_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			selectToggle(e.target);
			// It's too inconvenient if the cursor is caught again on mobile..
		...
		//color text select box
		colorTextSelectBox_onClick : function(e) {
		},
		//colorText R Input event
		colorTextRInput_onClick : function(e) {
		},
		colorTextRInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		colorTextRInput_onBlur : function(e) {
		...
		//colorText G Input event
		colorTextGInput_onClick : function(e) {
		},
		colorTextGInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		colorTextGInput_onBlur : function(e) {
			var value = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!checkHex(value)) {
		...
		//colorText B Input event
		colorTextBInput_onClick : function(e) {
		},
		colorTextBInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		colorTextBInput_onBlur : function(e) {
			var value = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!checkHex(value)) {
		...
		//colorText Opacity Input event
		colorTextOpacityInput_onClick : function(e) {
		},
		colorTextOpacityInput_onInput : function(e) {
		...
		colorTextOpacityInput_onBlur : function(e) {
			var value = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		//==================================================================================
		//color background select
		colorBackSelect_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			selectToggle(e.target);
			// It's too inconvenient if the cursor is caught again on mobile..
		...
		colorBackSelectBox_onClick : function(e) {
		},
		//colorBack R Input event
		colorBackRInput_onClick : function(e) {
		},
		colorBackRInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		colorBackRInput_onBlur : function(e) {
			var value = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!checkHex(value)) {
		...
		//colorBack G Input event
		colorBackGInput_onClick : function(e) {
		},
		colorBackGInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		colorBackGInput_onBlur : function(e) {
			var value = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!checkHex(value)) {
		...
		//colorBack B Input event
		colorBackBInput_onClick : function(e) {
		},
		colorBackBInput_onInput : function(e) {
			if(!e.target.value) return;
			var inputValue = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
		...
		colorBackBInput_onBlur : function(e) {
			var value = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!checkHex(value)) {
		...
		//colorBack Opacity Input event
		colorBackOpacityInput_onClick : function(e) {
		},
		colorBackOpacityInput_onInput : function(e) {
			if(e.target.value === "01" || e.target.value === "10") {
				e.target.value = e.data;
			} 
			if(!e.target.value) return;
		...
		colorBackOpacityInput_onBlur : function(e) {
			var value = e.target.value;
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			if(!checkRealNumber(value)) {
		...
		//==================================================================================
		//formatClearButton
		formatClearButton_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			// If the selection is a single point
			if (Vanillanote.variables.editRanges[noteIndex] && Vanillanote.variables.editRanges[noteIndex].collapsed) {
		...
		helpModal_onClick : function(e) {},
		
		//==================================================================================
		//modal back
		modalBack_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			closeAllModal(noteIndex);
		},
		...
		//==================================================================================
		//placeholder
		placeholder_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			if(!noteIndex) return;
			closePlaceholder(noteIndex);
		...
		//textarea
		//==================================================================================
		textarea_onClick : function(e) {
			var noteIndex = getNoteIndex(e.target);
			closeAllSelectBoxes(noteIndex);
		},
		textarea_onFocus : function(e) {
 			var noteIndex = getNoteIndex(e.target);
 			if(!noteIndex) return;
 			// Close placeholder.
 			closePlaceholder(noteIndex);
	    ...
	    textarea_onBeforeinput: function(e) {
		...
		document_onSelectionchange : function(e) {
			var selection = window.getSelection();
			if (!selection || selection.rangeCount < 1) return;
			var range = selection.getRangeAt(0);
			
		    // Check if it's inside the note.
			var textarea = range.startContainer;
			var note = range.startContainer;
			var isTextarea = false;
...
//			setEditSelection(noteIndex, selection);
	...
	*/
	var createElement = function(element, elementTag, id, className, idx, appendNodeSetObject) {
		...
		if(appendNodeSetObject && typeof appendNodeSetObject === "object" && Object.keys(appendNodeSetObject).length !== 0) {
			...
			if(appendNodeSetObject["isIcon"]) {	//google icon
				...
				iconNode.setAttribute("data-note-index",idx);
	...
	*/
	var addClickEvent = function(element, id) {
	...
	*/
	var addMouseoverEvent = function(element, id) {
	...
	*/
	var addMouseoutEvent = function(element, id) {
	...
	*/
	var addTouchstartEvent = function(element, id) {
	...
	* @param {string} id - The id associated with the element.
	*/
	var addTouchendEvent = function(element, id) {
	...
	var createElementBasic = function(element, elementTag, id, className, idx, appendNodeSetObject) {
		element = createElement(element, elementTag, id, className, idx, appendNodeSetObject);
		addClickEvent(element, id);
		return element;
	};
	
	var createElementSelect = function(element, elementTag, id, className, idx, appendNodeSetObject) {
		element = createElement(element, elementTag, id, className, idx, appendNodeSetObject);
	...
	var createElementSelectBox = function(element, elementTag, id, className, idx) {
		return createElement(element, elementTag, id, className, idx);
	};
	
	var createElementButton = function(element, elementTag, id, className, idx, appendNodeSetObject) {
		element = createElement(element, elementTag, id, className, idx, appendNodeSetObject);
		element.classList.add(getClickCssEventElementClassName());
		element.classList.add(getOnOverCssEventElementClassName());
		addClickEvent(element, id);
	...
	var createElementInput = function(element, id, className, idx) {
	...
	var createElementInputCheckbox = function(element, id, className, idx) {
		element = createElement(element, "input", id, className, idx);
		element.setAttribute("name", getId(idx, id));
		element.setAttribute("placeholder","");
	...
	var createElementInputRadio = function(element, id, className, name, idx) {
		element = createElement(element, "input", id, className, idx);
	...
	var createElementRadioLabel = function(forId, iconName) {
		var tempEl1;
		var tempEl2;
	...
	var createElementFontFamiliySelect = function(element, elementTag, id, className, idx, appendNodeSetObject) {
		element = createElement(element, elementTag, id, className, idx, appendNodeSetObject);
		// The font event is dynamically generated
		Vanillanote.elementEvents[id+"_onBeforeClick"] = function(event) {return true;};
		elementsEvent[id+"_onClick"] = function(event) {
		...
		Vanillanote.elementEvents[id+"_onAfterClick"] = function(event) {};
		element.classList.add(getClickCssEventElementClassName());
		element.classList.add(getOnOverCssEventElementClassName());
		addClickEvent(element, id);
		addMouseoverEvent(element, id);
	...
	var setColor = function(mainColor) {
	...
	Vanillanote.eventStore.selectionchange = function(event) {
	...
	for(var i = 0; i < Vanillanote.elements.notes.length; i++) {
		...
		for(var removeFontIdx = 0; removeFontIdx < removeFontFamilies.length; removeFontIdx++) {
			...
			defaultFontFamilies = defaultFontFamilies.filter(function(fontFamily) {
...
//		}
		...
		//element css
  		...
  		for(var j = 0; j < cssKeys.length; j++) {
			cssText = cssText + getCssClassText(i, cssKeys[j], Vanillanote.csses[cssKeys[j]][i]) + "\n";
  		}
  		
		//==================================================================================
		//template
		template = createElement(template, "div", Vanillanote.consts.KEYS.template.id, Vanillanote.consts.KEYS.template.className, i);
		template.style.display = "none";
		//==================================================================================
 		//textarea
		textarea = createElementBasic(textarea, Vanillanote.variables.noteName+"-textarea", Vanillanote.consts.KEYS.textarea.id, Vanillanote.consts.KEYS.textarea.className, i);
		textarea.setAttribute("contenteditable",true);
		textarea.setAttribute("role","textbox");
		textarea.setAttribute("aria-multiline",true);
		textarea.setAttribute("spellcheck",true);
		textarea.setAttribute("autocorrect",true);
		textarea.setAttribute("name",getId(i, Vanillanote.consts.KEYS.textarea.id));
		textarea.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].textareaTooltip);	//COMMENT
 		...
 		textarea.addEventListener(Vanillanote.variables.isIOS ? "mouseout" : "blur", function(event) {
		...
		//tool
		//==================================================================================
		tool = createElement(tool, "div", Vanillanote.consts.KEYS.tool.id, Vanillanote.consts.KEYS.tool.className, i);
		//==================================================================================
		//tool toggle
		toolToggleButton = createElementButton(toolToggleButton, "span", Vanillanote.consts.KEYS.toolToggleButton.id, Vanillanote.consts.KEYS.toolToggleButton.className, i, {"isIcon":true, "text":"arrow_drop_down"});
		//==================================================================================
		//paragraph style
		paragraphStyleSelect = createElementSelect(paragraphStyleSelect, "span", Vanillanote.consts.KEYS.paragraphStyleSelect.id, Vanillanote.consts.KEYS.paragraphStyleSelect.className, i, {"isIcon":true, "text":"auto_fix_high"});
		paragraphStyleSelect.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].styleTooltip);	//COMMENT
		paragraphStyleSelectBox = createElementSelectBox(paragraphStyleSelectBox, "div", Vanillanote.consts.KEYS.paragraphStyleSelectBox.id, Vanillanote.consts.KEYS.paragraphStyleSelectBox.className, i);
		paragraphStyleSelect.appendChild(paragraphStyleSelectBox);
		tempElement1 = createElementButton(tempElement1, "div", Vanillanote.consts.KEYS.styleNomal.id, Vanillanote.consts.KEYS.styleNomal.className, i, {"isIcon":false, "text":"Normal"});
		tempElement1.setAttribute("data-tag-name","p");
		paragraphStyleSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "h1", Vanillanote.consts.KEYS.styleHeader1.id, Vanillanote.consts.KEYS.styleHeader1.className, i, {"isIcon":false, "text":"Header1"});
		tempElement1.setAttribute("data-tag-name","H1");
		paragraphStyleSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "h2", Vanillanote.consts.KEYS.styleHeader2.id, Vanillanote.consts.KEYS.styleHeader2.className, i, {"isIcon":false, "text":"Header2"});
		tempElement1.setAttribute("data-tag-name","H2");
		paragraphStyleSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "h3", Vanillanote.consts.KEYS.styleHeader3.id, Vanillanote.consts.KEYS.styleHeader3.className, i, {"isIcon":false, "text":"Header3"});
		tempElement1.setAttribute("data-tag-name","H3");
		paragraphStyleSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "h4", Vanillanote.consts.KEYS.styleHeader4.id, Vanillanote.consts.KEYS.styleHeader4.className, i, {"isIcon":false, "text":"Header4"});
		tempElement1.setAttribute("data-tag-name","H4");
		paragraphStyleSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "h5", Vanillanote.consts.KEYS.styleHeader5.id, Vanillanote.consts.KEYS.styleHeader5.className, i, {"isIcon":false, "text":"Header5"});
		tempElement1.setAttribute("data-tag-name","H5");
		paragraphStyleSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "h6", Vanillanote.consts.KEYS.styleHeader6.id, Vanillanote.consts.KEYS.styleHeader6.className, i, {"isIcon":false, "text":"Header6"});
		tempElement1.setAttribute("data-tag-name","H6");
		paragraphStyleSelectBox.appendChild(tempElement1);
		//==================================================================================
		//bold
		boldButton = createElementButton(boldButton, "span", Vanillanote.consts.KEYS.boldButton.id, Vanillanote.consts.KEYS.boldButton.className, i, {"isIcon":true, "text":"format_bold"});
		boldButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].boldTooltip);	//COMMENT
		//==================================================================================
		//under-line
		underlineButton = createElementButton(underlineButton, "span", Vanillanote.consts.KEYS.underlineButton.id, Vanillanote.consts.KEYS.underlineButton.className, i, {"isIcon":true, "text":"format_underlined"});
		underlineButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].underlineTooltip);	//COMMENT
		//==================================================================================
		//italic
		italicButton = createElementButton(italicButton, "span", Vanillanote.consts.KEYS.italicButton.id, Vanillanote.consts.KEYS.italicButton.className, i, {"isIcon":true, "text":"format_italic"});
		italicButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].italicTooltip);
		//==================================================================================
		//ul
		ulButton = createElementButton(italicButton, "span", Vanillanote.consts.KEYS.ulButton.id, Vanillanote.consts.KEYS.ulButton.className, i, {"isIcon":true, "text":"format_list_bulleted"});
		...
		//==================================================================================
		//ol
		olButton = createElementButton(ulButton, "span", Vanillanote.consts.KEYS.olButton.id, Vanillanote.consts.KEYS.olButton.className, i, {"isIcon":true, "text":"format_list_numbered"});
		...
		//==================================================================================
		//text-align
		textAlignSelect = createElementSelect(textAlignSelect, "span",  Vanillanote.consts.KEYS.textAlignSelect.id, Vanillanote.consts.KEYS.textAlignSelect.className, i, {"isIcon":true, "text":"notes"});
		textAlignSelect.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].textAlignTooltip);	//COMMENT
		textAlignSelectBox = createElementSelectBox(textAlignSelectBox, "div", Vanillanote.consts.KEYS.textAlignSelectBox.id, Vanillanote.consts.KEYS.textAlignSelectBox.className, i);
		textAlignSelect.appendChild(textAlignSelectBox);
		tempElement1 = createElementButton(tempElement1, "span", Vanillanote.consts.KEYS.textAlignLeft.id, Vanillanote.consts.KEYS.textAlignLeft.className, i, {"isIcon":true, "text":"format_align_left"});
		tempElement1.setAttribute("data-tag-style","text-align:left;");
		textAlignSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "span", Vanillanote.consts.KEYS.textAlignCenter.id, Vanillanote.consts.KEYS.textAlignCenter.className, i, {"isIcon":true, "text":"format_align_center"});
		tempElement1.setAttribute("data-tag-style","text-align:center;");
		textAlignSelectBox.appendChild(tempElement1);
		tempElement1 = createElementButton(tempElement1, "span", Vanillanote.consts.KEYS.textAlignRight.id, Vanillanote.consts.KEYS.textAlignRight.className, i, {"isIcon":true, "text":"format_align_right"});
		tempElement1.setAttribute("data-tag-style","text-align:right;");
		textAlignSelectBox.appendChild(tempElement1);
		//==================================================================================
		//att link
		attLinkButton = createElementButton(attLinkButton, "span", Vanillanote.consts.KEYS.attLinkButton.id, Vanillanote.consts.KEYS.attLinkButton.className, i, {"isIcon":true, "text":"link"});
		attLinkButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].attLinkTooltip);	//COMMENT
		//==================================================================================
		//att file
		attFileButton = createElementButton(attFileButton, "span", Vanillanote.consts.KEYS.attFileButton.id, Vanillanote.consts.KEYS.attFileButton.className, i, {"isIcon":true, "text":"attach_file"});
		attFileButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].attFileTooltip);	//COMMENT
		//==================================================================================
		//att image
		attImageButton = createElementButton(attImageButton, "span", Vanillanote.consts.KEYS.attImageButton.id, Vanillanote.consts.KEYS.attImageButton.className, i, {"isIcon":true, "text":"image"});
		attImageButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].attImageTooltip);	//COMMENT
		//==================================================================================
		//att video
		attVideoButton = createElementButton(attVideoButton, "span", Vanillanote.consts.KEYS.attVideoButton.id, Vanillanote.consts.KEYS.attVideoButton.className, i, {"isIcon":true, "text":"videocam"});
		attVideoButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].attVideoTooltip);	//COMMENT
		//==================================================================================
		//font size
		fontSizeInputBox = createElementButton(fontSizeInputBox, "span", Vanillanote.consts.KEYS.fontSizeInputBox.id, Vanillanote.consts.KEYS.fontSizeInputBox.className, i, {"isIcon":true, "text":"format_size"});
		fontSizeInput = createElementInput(fontSizeInput, Vanillanote.consts.KEYS.fontSizeInput.id, Vanillanote.consts.KEYS.fontSizeInput.className, i);
		...
		addClickEvent(fontSizeInput, Vanillanote.consts.KEYS.fontSizeInput.id);
		fontSizeInputBox.appendChild(fontSizeInput);
		//==================================================================================
		//letter spacing
		letterSpacingInputBox = createElementButton(letterSpacingInputBox, "span", Vanillanote.consts.KEYS.letterSpacingInputBox.id, Vanillanote.consts.KEYS.letterSpacingInputBox.className, i, {"isIcon":true, "text":"swap_horiz"});
		letterSpacingInput = createElementInput(letterSpacingInput, Vanillanote.consts.KEYS.letterSpacingInput.id, Vanillanote.consts.KEYS.letterSpacingInput.className, i);
		...
		addClickEvent(letterSpacingInput, Vanillanote.consts.KEYS.letterSpacingInput.id);
		letterSpacingInputBox.appendChild(letterSpacingInput);
		//==================================================================================
		//line height
		lineHeightInputBox = createElementButton(lineHeightInputBox, "span", Vanillanote.consts.KEYS.lineHeightInputBox.id, Vanillanote.consts.KEYS.lineHeightInputBox.className, i, {"isIcon":true, "text":"height"});
		lineHeightInput = createElementInput(lineHeightInput, Vanillanote.consts.KEYS.lineHeightInput.id, Vanillanote.consts.KEYS.lineHeightInput.className, i);
		...
		addClickEvent(lineHeightInput, Vanillanote.consts.KEYS.lineHeightInput.id);
		lineHeightInputBox.appendChild(lineHeightInput);
		//==================================================================================
		//font style(font family)
		fontFamilySelect = createElementSelect(fontFamilySelect, "span", Vanillanote.consts.KEYS.fontFamilySelect.id, Vanillanote.consts.KEYS.fontFamilySelect.className, i, {"isIcon":false, "text":defaultFontFamiliy.length > 12 ? defaultFontFamiliy.substr(0,12) + "..." : defaultFontFamiliy});
		...
		fontFamilySelectBox = createElementSelectBox(fontFamilySelectBox, "div", Vanillanote.consts.KEYS.fontFamilySelectBox.id, Vanillanote.consts.KEYS.fontFamilySelectBox.className, i);
		fontFamilySelect.appendChild(fontFamilySelectBox);
		
		for(var fontIdx = 0; fontIdx < defaultFontFamilies.length; fontIdx++) {
			tempElement1 = createElementFontFamiliySelect(tempElement1, "div", Vanillanote.consts.KEYS.fontFamily.id + fontIdx, Vanillanote.consts.KEYS.fontFamily.className, i, {"isIcon":false, "text":defaultFontFamilies[fontIdx]});
		...
		//==================================================================================
		//color text select
		colorTextSelect = createElementSelect(colorTextSelect, "span", Vanillanote.consts.KEYS.colorTextSelect.id, Vanillanote.consts.KEYS.colorTextSelect.className, i, {"isIcon":true, "text":"format_color_text", "iconStyle" : "-webkit-text-stroke: 0.5px black; font-size: 1.1em"});
		colorTextSelect.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].colorTextTooltip);	//COMMENT
		colorTextSelectBox = createElementSelectBox(colorTextSelectBox, "div", Vanillanote.consts.KEYS.colorTextSelectBox.id, Vanillanote.consts.KEYS.colorTextSelectBox.className, i);
		colorTextSelect.appendChild(colorTextSelectBox);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorTextRExplain.id, Vanillanote.consts.KEYS.colorTextRExplain.className, i, {"isIcon":false, "text":"R"});	//COMMENT
		tempElement1.style.paddingLeft = (Vanillanote.variables.sizeRates[i] * 8) + "px";
		colorTextSelectBox.appendChild(tempElement1);
		colorTextRInput = createElementInput(colorTextRInput, Vanillanote.consts.KEYS.colorTextRInput.id, Vanillanote.consts.KEYS.colorTextRInput.className, i);
		colorTextRInput.setAttribute("maxlength", "2");
		addClickEvent(colorTextRInput, Vanillanote.consts.KEYS.colorTextRInput.id);
		colorTextSelectBox.appendChild(colorTextRInput);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorTextGExplain.id, Vanillanote.consts.KEYS.colorTextGExplain.className, i, {"isIcon":false, "text":"G"});	//COMMENT
		colorTextSelectBox.appendChild(tempElement1);
		colorTextGInput = createElementInput(colorTextGInput, Vanillanote.consts.KEYS.colorTextGInput.id, Vanillanote.consts.KEYS.colorTextGInput.className, i);
		colorTextGInput.setAttribute("maxlength", "2");
		addClickEvent(colorTextGInput, Vanillanote.consts.KEYS.colorTextGInput.id);
		colorTextSelectBox.appendChild(colorTextGInput);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorTextBExplain.id, Vanillanote.consts.KEYS.colorTextBExplain.className, i, {"isIcon":false, "text":"B"});	//COMMENT
		colorTextSelectBox.appendChild(tempElement1);
		colorTextBInput = createElementInput(colorTextBInput, Vanillanote.consts.KEYS.colorTextBInput.id, Vanillanote.consts.KEYS.colorTextBInput.className, i);
		colorTextBInput.setAttribute("maxlength", "2");
		addClickEvent(colorTextBInput, Vanillanote.consts.KEYS.colorTextBInput.id);
		colorTextSelectBox.appendChild(colorTextBInput);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorTextOpacityExplain.id, Vanillanote.consts.KEYS.colorTextOpacityExplain.className, i, {"isIcon":false, "text":"Opacity"});	//COMMENT
		colorTextSelectBox.appendChild(tempElement1);
		colorTextOpacityInput = createElementInput(colorTextOpacityInput, Vanillanote.consts.KEYS.colorTextOpacityInput.id, Vanillanote.consts.KEYS.colorTextOpacityInput.className, i);
		colorTextOpacityInput.setAttribute("type","number");
		colorTextOpacityInput.setAttribute("maxlength", "3");
		addClickEvent(colorTextOpacityInput, Vanillanote.consts.KEYS.colorTextOpacityInput.id);
		colorTextSelectBox.appendChild(colorTextOpacityInput);
		tempElement1 = document.createElement("br");
		colorTextSelectBox.appendChild(tempElement1);
		colorText0 = createElementBasic(colorText0, "div", Vanillanote.consts.KEYS.colorText0.id, Vanillanote.consts.KEYS.colorText0.className, i);
		colorText0.style.backgroundColor = Vanillanote.colors.color12[i];
		colorTextSelectBox.appendChild(colorText0);
		colorText1 = createElementBasic(colorText1, "div", Vanillanote.consts.KEYS.colorText1.id, Vanillanote.consts.KEYS.colorText1.className, i);
		colorText1.style.backgroundColor = Vanillanote.colors.color14[i];
		colorTextSelectBox.appendChild(colorText1);
		colorText2 = createElementBasic(colorText2, "div", Vanillanote.consts.KEYS.colorText2.id, Vanillanote.consts.KEYS.colorText2.className, i);
		colorText2.style.backgroundColor = Vanillanote.colors.color15[i];
		colorTextSelectBox.appendChild(colorText2);
		colorText3 = createElementBasic(colorText3, "div", Vanillanote.consts.KEYS.colorText3.id, Vanillanote.consts.KEYS.colorText3.className, i);
		colorText3.style.backgroundColor = Vanillanote.colors.color16[i];
		colorTextSelectBox.appendChild(colorText3);
		colorText4 = createElementBasic(colorText4, "div", Vanillanote.consts.KEYS.colorText4.id, Vanillanote.consts.KEYS.colorText4.className, i);
		colorText4.style.backgroundColor = Vanillanote.colors.color17[i];
		colorTextSelectBox.appendChild(colorText4);
		colorText5 = createElementBasic(colorText5, "div", Vanillanote.consts.KEYS.colorText5.id, Vanillanote.consts.KEYS.colorText5.className, i);
		colorText5.style.backgroundColor = Vanillanote.colors.color18[i];
		colorTextSelectBox.appendChild(colorText5);
		colorText6 = createElementBasic(colorText6, "div", Vanillanote.consts.KEYS.colorText6.id, Vanillanote.consts.KEYS.colorText6.className, i);
		colorText6.style.backgroundColor = Vanillanote.colors.color19[i];
		colorTextSelectBox.appendChild(colorText6);
		colorText7 = createElementBasic(colorText7, "div", Vanillanote.consts.KEYS.colorText7.id, Vanillanote.consts.KEYS.colorText7.className, i);
		colorText7.style.backgroundColor = Vanillanote.colors.color20[i];
		colorTextSelectBox.appendChild(colorText7);
		//==================================================================================
		//color background select
		colorBackSelect = createElementSelect(colorBackSelect, "span", Vanillanote.consts.KEYS.colorBackSelect.id, Vanillanote.consts.KEYS.colorBackSelect.className, i, {"isIcon":true, "text":"format_color_fill", "iconStyle" : "font-size: 1.1em; -webkit-text-stroke: 0.5px " + Vanillanote.colors.color1[i]+";"});
		colorBackSelect.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].colorBackTooltip);	//COMMENT
		colorBackSelectBox = createElementSelectBox(colorBackSelectBox, "div", Vanillanote.consts.KEYS.colorBackSelectBox.id, Vanillanote.consts.KEYS.colorBackSelectBox.className, i);
		colorBackSelect.appendChild(colorBackSelectBox);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorBackRExplain.id, Vanillanote.consts.KEYS.colorBackRExplain.className, i, {"isIcon":false, "text":"R"});	//COMMENT
		tempElement1.style.paddingLeft = (Vanillanote.variables.sizeRates[i] * 8) + "px";
		colorBackSelectBox.appendChild(tempElement1);
		colorBackRInput = createElementInput(colorBackRInput, Vanillanote.consts.KEYS.colorBackRInput.id, Vanillanote.consts.KEYS.colorBackRInput.className, i);
		colorBackRInput.setAttribute("maxlength", "2");
		addClickEvent(colorBackRInput, Vanillanote.consts.KEYS.colorBackRInput.id);
		colorBackSelectBox.appendChild(colorBackRInput);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorBackGExplain.id, Vanillanote.consts.KEYS.colorBackGExplain.className, i, {"isIcon":false, "text":"G"});	//COMMENT
		colorBackSelectBox.appendChild(tempElement1);
		colorBackGInput = createElementInput(colorBackGInput, Vanillanote.consts.KEYS.colorBackGInput.id, Vanillanote.consts.KEYS.colorBackGInput.className, i);
		colorBackGInput.setAttribute("maxlength", "2");
		addClickEvent(colorBackGInput, Vanillanote.consts.KEYS.colorBackGInput.id);
		colorBackSelectBox.appendChild(colorBackGInput);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorBackBExplain.id, Vanillanote.consts.KEYS.colorBackBExplain.className, i, {"isIcon":false, "text":"B"});	//COMMENT
		colorBackSelectBox.appendChild(tempElement1);
		colorBackBInput = createElementInput(colorBackBInput, Vanillanote.consts.KEYS.colorBackBInput.id, Vanillanote.consts.KEYS.colorBackBInput.className, i);
		colorBackBInput.setAttribute("maxlength", "2");
		addClickEvent(colorBackBInput, Vanillanote.consts.KEYS.colorBackBInput.id);
		colorBackSelectBox.appendChild(colorBackBInput);
		tempElement1 = createElement(tempElement1, "span", Vanillanote.consts.KEYS.colorBackOpacityExplain.id, Vanillanote.consts.KEYS.colorBackOpacityExplain.className, i, {"isIcon":false, "text":"Opacity"});	//COMMENT
		colorBackSelectBox.appendChild(tempElement1);
		colorBackOpacityInput = createElementInput(colorBackOpacityInput, Vanillanote.consts.KEYS.colorBackOpacityInput.id, Vanillanote.consts.KEYS.colorBackOpacityInput.className, i);
		colorBackOpacityInput.setAttribute("type","number");
		colorBackOpacityInput.setAttribute("maxlength", "3");
		addClickEvent(colorBackOpacityInput, Vanillanote.consts.KEYS.colorBackOpacityInput.id);
		colorBackSelectBox.appendChild(colorBackOpacityInput);
		tempElement1 = document.createElement("br");
		colorBackSelectBox.appendChild(tempElement1);
		colorBack0 = createElementBasic(colorBack0, "div", Vanillanote.consts.KEYS.colorBack0.id, Vanillanote.consts.KEYS.colorBack0.className, i);
		colorBack0.style.backgroundColor = Vanillanote.colors.color13[i];
		colorBackSelectBox.appendChild(colorBack0);
		colorBack1 = createElementBasic(colorBack1, "div", Vanillanote.consts.KEYS.colorBack1.id, Vanillanote.consts.KEYS.colorBack1.className, i);
		colorBack1.style.backgroundColor = Vanillanote.colors.color14[i];
		colorBackSelectBox.appendChild(colorBack1);
		colorBack2 = createElementBasic(colorBack2, "div", Vanillanote.consts.KEYS.colorBack2.id, Vanillanote.consts.KEYS.colorBack2.className, i);
		colorBack2.style.backgroundColor = Vanillanote.colors.color15[i];
		colorBackSelectBox.appendChild(colorBack2);
		colorBack3 = createElementBasic(colorBack3, "div", Vanillanote.consts.KEYS.colorBack3.id, Vanillanote.consts.KEYS.colorBack3.className, i);
		colorBack3.style.backgroundColor = Vanillanote.colors.color16[i];
		colorBackSelectBox.appendChild(colorBack3);
		colorBack4 = createElementBasic(colorBack4, "div", Vanillanote.consts.KEYS.colorBack4.id, Vanillanote.consts.KEYS.colorBack4.className, i);
		colorBack4.style.backgroundColor = Vanillanote.colors.color17[i];
		colorBackSelectBox.appendChild(colorBack4);
		colorBack5 = createElementBasic(colorBack5, "div", Vanillanote.consts.KEYS.colorBack5.id, Vanillanote.consts.KEYS.colorBack5.className, i);
		colorBack5.style.backgroundColor = Vanillanote.colors.color18[i];
		colorBackSelectBox.appendChild(colorBack5);
		colorBack6 = createElementBasic(colorBack6, "div", Vanillanote.consts.KEYS.colorBack6.id, Vanillanote.consts.KEYS.colorBack6.className, i);
		colorBack6.style.backgroundColor = Vanillanote.colors.color19[i];
		colorBackSelectBox.appendChild(colorBack6);
		colorBack7 = createElementBasic(colorBack7, "div", Vanillanote.consts.KEYS.colorBack7.id, Vanillanote.consts.KEYS.colorBack7.className, i);
		colorBack7.style.backgroundColor = Vanillanote.colors.color20[i];
		colorBackSelectBox.appendChild(colorBack7);
		//==================================================================================
		//formatClearButton
		//==================================================================================
		formatClearButton = createElementButton(formatClearButton, "span", Vanillanote.consts.KEYS.formatClearButton.id, Vanillanote.consts.KEYS.formatClearButton.className, i, {"isIcon":true, "text":"format_clear"});
		...
		//undo
		//==================================================================================
		undoButton = createElementButton(undoButton, "span", Vanillanote.consts.KEYS.undoButton.id, Vanillanote.consts.KEYS.undoButton.className, i, {"isIcon":true, "text":"undo"});
		undoButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].undoTooltip);	//COMMENT
		//==================================================================================
		//redo
		//==================================================================================
		redoButton = createElementButton(redoButton, "span", Vanillanote.consts.KEYS.redoButton.id, Vanillanote.consts.KEYS.redoButton.className, i, {"isIcon":true, "text":"redo"});
		redoButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].redoTooltip);	//COMMENT
		//==================================================================================
		//help
		//==================================================================================
		helpButton = createElementButton(helpButton, "span", Vanillanote.consts.KEYS.helpButton.id, Vanillanote.consts.KEYS.helpButton.className, i, {"isIcon":true, "text":"help"});
		helpButton.setAttribute("title",Vanillanote.languageSet[Vanillanote.variables.languages[i]].helpTooltip);	//COMMENT
		//==================================================================================
		//modal
		//==================================================================================
		modalBack = createElementBasic(modalBack, "div", Vanillanote.consts.KEYS.modalBack.id, Vanillanote.consts.KEYS.modalBack.className, i);
		//==================================================================================
		//modal att link
		attLinkModal = createElementBasic(attLinkModal, "div", Vanillanote.consts.KEYS.attLinkModal.id, Vanillanote.consts.KEYS.attLinkModal.className, i);
		
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attLinkHeader.id, Vanillanote.consts.KEYS.attLinkHeader.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attLinkModalTitle});	//COMMENT
		attLinkModal.appendChild(tempElement1);
		
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attLinkExplain1.id, Vanillanote.consts.KEYS.attLinkExplain1.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attLinkInTextExplain});	//COMMENT
		attLinkModal.appendChild(tempElement1);
		
		attLinkText = createElementInput(attLinkText, Vanillanote.consts.KEYS.attLinkText.id, Vanillanote.consts.KEYS.attLinkText.className, i);
		...
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attLinkExplain2.id, Vanillanote.consts.KEYS.attLinkExplain2.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attLinkInLinkExplain});	//COMMENT
		attLinkModal.appendChild(tempElement1);
		
		attLinkHref = createElementInput(attLinkHref, Vanillanote.consts.KEYS.attLinkHref.id, Vanillanote.consts.KEYS.attLinkHref.className, i);
		...
		attLinkIsBlankCheckbox = createElementInputCheckbox(attLinkIsBlankCheckbox, Vanillanote.consts.KEYS.attLinkIsBlankCheckbox.id, Vanillanote.consts.KEYS.attLinkIsBlankCheckbox.className, i);
		...
		tempElement1 = createElement(tempElement1, "label", Vanillanote.consts.KEYS.attLinkIsBlankLabel.id, Vanillanote.consts.KEYS.attLinkIsBlankLabel.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attLinkIsOpenExplain});
		tempElement1.insertBefore(attLinkIsBlankCheckbox, tempElement1.firstChild);
		attLinkModal.appendChild(tempElement1);
		
		attLinkValidCheckText = createElement(attLinkValidCheckText, "span", Vanillanote.consts.KEYS.attLinkValidCheckText.id, Vanillanote.consts.KEYS.attLinkValidCheckText.className, i);
		attLinkValidCheckbox = createElementInputCheckbox(attLinkIsBlankCheckbox, Vanillanote.consts.KEYS.attLinkValidCheckbox.id, Vanillanote.consts.KEYS.attLinkValidCheckbox.className, i);
		attLinkValidCheckbox.style.display = "none";
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attLinkFooter.id, Vanillanote.consts.KEYS.attLinkFooter.className, i);
		attLinkInsertButton = createElementButton(attLinkInsertButton, "button", Vanillanote.consts.KEYS.attLinkInsertButton.id, Vanillanote.consts.KEYS.attLinkInsertButton.className, i, {"isIcon":true, "text":"add_link"});
		...
		//==================================================================================
		//modal att file
		attFileModal = createElementBasic(attFileModal, "div", Vanillanote.consts.KEYS.attFileModal.id, Vanillanote.consts.KEYS.attFileModal.className, i);
	    tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attFileHeader.id, Vanillanote.consts.KEYS.attFileHeader.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attFileModalTitle});	//COMMENT
	    attFileModal.appendChild(tempElement1);
	    
		//layout : upload file
	    attFilelayout = createElement(attFilelayout, "div", Vanillanote.consts.KEYS.attFilelayout.id, Vanillanote.consts.KEYS.attFilelayout.className, i);
	    
	    tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attFileExplain1.id, Vanillanote.consts.KEYS.attFileExplain1.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attFileExplain1});	//COMMENT
	    ...
	    attFileUploadDiv = createElementButton(attFileUploadDiv, "div", Vanillanote.consts.KEYS.attFileUploadDiv.id, Vanillanote.consts.KEYS.attFileUploadDiv.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attFileUploadDiv});
	    attFileUploadDiv.addEventListener("dragover", function(event) {
	    ...
	    attFileUploadDiv.addEventListener("drop", function(event) {
	    ...
	    attFileUploadButton = createElementButton(attFileUploadButton, "button", Vanillanote.consts.KEYS.attFileUploadButton.id, Vanillanote.consts.KEYS.attFileUploadButton.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attFileUploadButton});
	    tempElement1.appendChild(attFileUploadButton);
	    attFilelayout.appendChild(tempElement1);

	    attFileUpload = createElementInput(attFileUpload, Vanillanote.consts.KEYS.attFileUpload.id, Vanillanote.consts.KEYS.attFileUpload.className, i);
	    ...
	    tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attFileFooter.id, Vanillanote.consts.KEYS.attFileFooter.className, i);
	    attFileInsertButton = createElementButton(attFileInsertButton, "button", Vanillanote.consts.KEYS.attFileInsertButton.id, Vanillanote.consts.KEYS.attFileInsertButton.className, i, {"isIcon":true, "text":"attach_file"});
	    tempElement1.appendChild(attFileInsertButton);
	    attFileModal.appendChild(tempElement1);
		//==================================================================================
		//modal att image
		attImageModal = createElementBasic(attImageModal, "div", Vanillanote.consts.KEYS.attImageModal.id, Vanillanote.consts.KEYS.attImageModal.className, i);
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attImageHeader.id, Vanillanote.consts.KEYS.attImageHeader.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attImageModalTitle});	//COMMENT
		attImageModal.appendChild(tempElement1);
		
	    tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attImageExplain1.id, Vanillanote.consts.KEYS.attImageExplain1.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attImageExplain1});	//COMMENT
	    attImageModal.appendChild(tempElement1);
	    tempElement1 = document.createElement("br");
	    attImageModal.appendChild(tempElement1);
	    ...
	    attImageViewPreButtion = createElementButton(attImageInsertButton, "button", Vanillanote.consts.KEYS.attImageViewPreButtion.id, Vanillanote.consts.KEYS.attImageViewPreButtion.className, i, {"isIcon":true, "text":"navigate_before"});
	    ...
	    attImageUploadButtonAndView = createElementBasic(attImageUploadButtonAndView, "div", Vanillanote.consts.KEYS.attImageUploadButtonAndView.id, Vanillanote.consts.KEYS.attImageUploadButtonAndView.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attImageUploadButtonAndView});
	    attImageUploadButtonAndView.addEventListener("dragover", function(event) {
	    ...
	    attImageUploadButtonAndView.addEventListener("drop", function(event) {
	    ...
	    attImageViewNextButtion = createElementButton(attImageInsertButton, "button", Vanillanote.consts.KEYS.attImageViewNextButtion.id, Vanillanote.consts.KEYS.attImageViewNextButtion.className, i, {"isIcon":true, "text":"navigate_next"});
	    ...
	    attImageUpload = createElementInput(attImageUpload, Vanillanote.consts.KEYS.attImageUpload.id, Vanillanote.consts.KEYS.attImageUpload.className, i);
	    ...
	    tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attImageExplain2.id, Vanillanote.consts.KEYS.attImageExplain2.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attImageExplain2});	//COMMENT
	    attImageModal.appendChild(tempElement1);
	    tempElement1 = document.createElement("br");
	    attImageModal.appendChild(tempElement1);
	    
	    attImageURL = createElementInput(attLinkHref, Vanillanote.consts.KEYS.attImageURL.id, Vanillanote.consts.KEYS.attImageURL.className, i);
	    ...
	    tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attImageFooter.id, Vanillanote.consts.KEYS.attImageFooter.className, i);
	    attImageInsertButton = createElementButton(attImageInsertButton, "button", Vanillanote.consts.KEYS.attImageInsertButton.id, Vanillanote.consts.KEYS.attImageInsertButton.className, i, {"isIcon":true, "text":"image"});
	    tempElement1.appendChild(attImageInsertButton);
	    attImageModal.appendChild(tempElement1);
		//==================================================================================
		//modal att video
		attVideoModal = createElementBasic(attVideoModal, "div", Vanillanote.consts.KEYS.attVideoModal.id, Vanillanote.consts.KEYS.attVideoModal.className, i);
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attVideoHeader.id, Vanillanote.consts.KEYS.attVideoHeader.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attVideoModalTitle});	//COMMENT
		attVideoModal.appendChild(tempElement1);
		
	    tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attVideoExplain1.id, Vanillanote.consts.KEYS.attVideoExplain1.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attVideoExplain1});	//COMMENT
	    attVideoModal.appendChild(tempElement1);

		attVideoEmbedId = createElementInput(attVideoEmbedId, Vanillanote.consts.KEYS.attVideoEmbedId.id, Vanillanote.consts.KEYS.attVideoEmbedId.className, i);
		...
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attVideoExplain2.id, Vanillanote.consts.KEYS.attVideoExplain2.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].attVideoExplain2});	//COMMENT
	    attVideoModal.appendChild(tempElement1);
		...
		attVideoWidth  = createElementInput(attVideoWidth, Vanillanote.consts.KEYS.attVideoWidth.id, Vanillanote.consts.KEYS.attVideoWidth.className, i);
		...
		tempElement1.appendChild(tempElement2);
		attVideoHeight = createElementInput(attVideoHeight, Vanillanote.consts.KEYS.attVideoHeight.id, Vanillanote.consts.KEYS.attVideoHeight.className, i);
		...
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attVideoFooter.id, Vanillanote.consts.KEYS.attVideoFooter.className, i);

		attVideoValidCheckText = createElement(attVideoValidCheckText, "span", Vanillanote.consts.KEYS.attVideoValidCheckText.id, Vanillanote.consts.KEYS.attVideoValidCheckText.className, i);
		attVideoValidCheckbox = createElementInputCheckbox(attVideoValidCheckbox, Vanillanote.consts.KEYS.attVideoValidCheckbox.id, Vanillanote.consts.KEYS.attVideoValidCheckbox.className, i);
		attVideoValidCheckbox.style.display = "none";
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.attVideoFooter.id, Vanillanote.consts.KEYS.attVideoFooter.className, i);
		attVideoInsertButton = createElementButton(attVideoInsertButton, "button", Vanillanote.consts.KEYS.attVideoInsertButton.id, Vanillanote.consts.KEYS.attVideoInsertButton.className, i, {"isIcon":true, "text":"videocam"});
		...
		//==================================================================================
		//att link tooltip
		attLinkTooltip = createElement(attLinkTooltip, "div", Vanillanote.consts.KEYS.attLinkTooltip.id, Vanillanote.consts.KEYS.attLinkTooltip.className, i);
		attLinkTooltipHref = createElement(attLinkTooltipHref, "a", Vanillanote.consts.KEYS.attLinkTooltipHref.id, Vanillanote.consts.KEYS.attLinkTooltipHref.className, i);
		attLinkTooltipHref.setAttribute("target","_blank");
		attLinkTooltipEditButton = createElementButton(attLinkTooltipEditButton, "span", Vanillanote.consts.KEYS.attLinkTooltipEditButton.id, Vanillanote.consts.KEYS.attLinkTooltipEditButton.className, i, {"isIcon":true, "text":"add_link", "iconStyle":"font-size:0.9em"});
		attLinkTooltipUnlinkButton = createElementButton(attLinkTooltipUnlinkButton, "span", Vanillanote.consts.KEYS.attLinkTooltipUnlinkButton.id, Vanillanote.consts.KEYS.attLinkTooltipUnlinkButton.className, i, {"isIcon":true, "text":"link_off", "iconStyle":"font-size:0.9em"});
		...
		//==================================================================================
		//att image tooltip
		attImageAndVideoTooltip = createElement(attImageAndVideoTooltip, "div", Vanillanote.consts.KEYS.attImageAndVideoTooltip.id, Vanillanote.consts.KEYS.attImageAndVideoTooltip.className, i);
		...
		attImageAndVideoTooltipWidthInput = createElementInput(attImageAndVideoTooltipWidthInput, Vanillanote.consts.KEYS.attImageAndVideoTooltipWidthInput.id, Vanillanote.consts.KEYS.attImageAndVideoTooltipWidthInput.className, i);
		attImageAndVideoTooltipWidthInput.addEventListener("keyup", function(event) {
		...
		attImageAndVideoTooltipFloatRadioNone = createElementInputRadio(
												attImageAndVideoTooltipFloatRadioNone,
												Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioNone.id,
												Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioNone.className,
												getId(i, "attImageAndVideoTooltipFloatRadio"),
												i
											);
		tempElement1.appendChild(attImageAndVideoTooltipFloatRadioNone);
		tempElement2 = createElementRadioLabel(getId(i, Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioNone.id), "close");
		tempElement1.appendChild(tempElement2);
		attImageAndVideoTooltipFloatRadioLeft = createElementInputRadio(
												attImageAndVideoTooltipFloatRadioLeft,
												Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioLeft.id,
												Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioLeft.className,
												getId(i, "attImageAndVideoTooltipFloatRadio"),
												i
											);
		tempElement1.appendChild(attImageAndVideoTooltipFloatRadioLeft);
		tempElement2 = createElementRadioLabel(getId(i, Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioLeft.id), "art_track");
		tempElement1.appendChild(tempElement2);
		attImageAndVideoTooltipFloatRadioRight = createElementInputRadio(
												attImageAndVideoTooltipFloatRadioRight,
												Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioRight.id,
												Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioRight.className,
												getId(i, "attImageAndVideoTooltipFloatRadio"),
												i
											);
		tempElement1.appendChild(attImageAndVideoTooltipFloatRadioRight);
		tempElement2 = createElementRadioLabel(getId(i, Vanillanote.consts.KEYS.attImageAndVideoTooltipFloatRadioRight.id), "burst_mode");
		tempElement1.appendChild(tempElement2);
		...
		attImageAndVideoTooltipShapeRadioSquare = createElementInputRadio(
													attImageAndVideoTooltipShapeRadioSquare,
													Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioSquare.id,
													Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioSquare.className,
													getId(i, "attImageAndVideoTooltipShapeRadio"),
													i
												);
		tempElement1.appendChild(attImageAndVideoTooltipShapeRadioSquare);
		tempElement2 = createElementRadioLabel(getId(i, Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioSquare.id), "crop_5_4");
		tempElement1.appendChild(tempElement2);
		attImageAndVideoTooltipShapeRadioRadius = createElementInputRadio(
													attImageAndVideoTooltipShapeRadioRadius,
													Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioRadius.id,
													Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioRadius.className,
													getId(i, "attImageAndVideoTooltipShapeRadio"),
													i
												);
		tempElement1.appendChild(attImageAndVideoTooltipShapeRadioRadius);
		tempElement2 = createElementRadioLabel(getId(i, Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioRadius.id), "aspect_ratio");
		tempElement1.appendChild(tempElement2);
		attImageAndVideoTooltipShapeRadioCircle = createElementInputRadio(
													attImageAndVideoTooltipShapeRadioCircle,
													Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioCircle.id,
													Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioCircle.className,
													getId(i, "attImageAndVideoTooltipShapeRadio"),
													i
												);
		tempElement1.appendChild(attImageAndVideoTooltipShapeRadioCircle);
		tempElement2 = createElementRadioLabel(getId(i, Vanillanote.consts.KEYS.attImageAndVideoTooltipShapeRadioCircle.id), "circle");
		tempElement1.appendChild(tempElement2);
		...
		//==================================================================================
		//modal help
		helpModal = createElementBasic(helpModal, "div", Vanillanote.consts.KEYS.helpModal.id, Vanillanote.consts.KEYS.helpModal.className, i);
		
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.helpHeader.id, Vanillanote.consts.KEYS.helpHeader.className, i, {"isIcon":false, "text":Vanillanote.languageSet[Vanillanote.variables.languages[i]].helpModalTitle});	//COMMENT
		helpModal.appendChild(tempElement1);
		
		helpMain = createElement(helpMain, "div", Vanillanote.consts.KEYS.helpMain.id, Vanillanote.consts.KEYS.helpMain.className, i);
		...
		tempElement1 = createElement(tempElement1, "div", Vanillanote.consts.KEYS.helpFooter.id, Vanillanote.consts.KEYS.helpFooter.className, i);
		...
		if(!Vanillanote.elements.placeholders[i]) {
			placeholder = createElementBasic(placeholder, "div", Vanillanote.consts.KEYS.placeholder.id, Vanillanote.consts.KEYS.placeholder.className, i);
    	...
    	Vanillanote.variables.attTempFiles.push(new Object);
    	Vanillanote.variables.attFiles.push(new Object);
    	Vanillanote.variables.attTempImages.push(new Object);
    	Vanillanote.variables.attImages.push(new Object);
...
// 		Vanillanote.variables.recodeNotes.push([Vanillanote.elements.textareas[i].cloneNode(true)]);
		...
		//set input values
		//==================================================================================
		Vanillanote.elements.fontSizeInputs[i].value = defaultFontSize;
		Vanillanote.elements.letterSpacingInputs[i].value = "0";
		Vanillanote.elements.lineHeightInputs[i].value = defaultLineHeight;
		
		Vanillanote.elements.colorTextRInputs[i].value = Vanillanote.variables.colorTextRs[i];
		Vanillanote.elements.colorTextGInputs[i].value = Vanillanote.variables.colorTextGs[i];
		Vanillanote.elements.colorTextBInputs[i].value = Vanillanote.variables.colorTextBs[i];
		Vanillanote.elements.colorTextOpacityInputs[i].value = Vanillanote.variables.colorTextOs[i];
		
		Vanillanote.elements.colorBackRInputs[i].value = Vanillanote.variables.colorBackRs[i];
		Vanillanote.elements.colorBackGInputs[i].value = Vanillanote.variables.colorBackGs[i];
		Vanillanote.elements.colorBackBInputs[i].value = Vanillanote.variables.colorBackBs[i];
		Vanillanote.elements.colorBackOpacityInputs[i].value = Vanillanote.variables.colorBackOs[i];
...
function destroyVanillanote(vn) {
	...
	document.removeEventListener("selectionchange", vn.eventStore.selectionchange);
	document.removeEventListener("keydown", vn.eventStore.keydown);
	window.removeEventListener("resize", vn.eventStore.resize);
	if(window.visualViewport) window.visualViewport.removeEventListener("resize", vn.eventStore.resizeViewport);
